...
namespace AndroidApp.ViewModel.QuestionnaireDetails
{
    public class CompleteQuestionnaireView : Cirrious.MvvmCross.ViewModels.MvxViewModel
    {
                                                                                 ...
                                                                                 ItemPublicKey key)
        {
            ...
            return
                parent.Children.OfType<ICompleteGroup>().Distinct(new PropagatedGroupEqualityComparer()).Select(
                    g => new ItemPublicKey(g.PublicKey, g.PropagationPublicKey)).ToList();
        }
