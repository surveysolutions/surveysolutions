...
namespace AndroidApp
{
    ...
    public class CapiApplication : Application
    {
        ...
        protected void GenerateEvents()
        {
            ...
            var s =
                @"{" +
  @"    ""$type"": ""Main.Core.Events.Questionnaire.Completed.NewCompleteQuestionnaireCreated, Main.Core""," +
  @"    ""CreationDate"": ""2012-09-06T23:05:28.0640000Z""," +
  @"    ""Questionnaire"": {" +
  @"      ""Children"": [" +
  @"        {" +
  ...
  @"  }";
            var payload = JsonConvert.DeserializeObject<NewCompleteQuestionnaireCreated>(s, settings);


            stream.Append(new UncommittedEvent(Guid.Parse("343fafa1-6373-4596-931e-1a3eeda10659"), Guid.Parse("9a9be11f-ccdb-4dfb-9705-4bae81153363"), 1, 0, DateTime.Now, payload, new Version()));
