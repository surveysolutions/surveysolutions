...
{
    public class YesNoCompleteQuestion:AbstractCompleteQuestion, IYesNoQuestion
    {
        ...
        {
            get { return this.Children.Where(c => ((ICompleteAnswer) c).Selected); } 
        }

        public override List<IComposite> Children { get; set; }

        public string AddYesNoAttr { get; set; }
