...
namespace Browsing.CAPI.Registration
{
    ...
    class CapiRegistrationManager : RegistrationManager
    {
        ...
        {
            var dataToFile = Encoding.ASCII.GetBytes(SerializeRegisterData(new RegisterData { SecretKey = rsaCryptoService.GetPublicKey(this.tabletId.ToString()).Modulus, TabletId = this.tabletId }));
