     ...
     //   private List<string> cachedDrives;
       ...
       /* /// <summary>
        ...
        protected void SubmitFile(UsbFileArchive usbArchive)
        {
            ...
            HttpWebRequest httpWebRequest2 = (HttpWebRequest)WebRequest.Create("http://localhost:8083/Synchronizations/Import");
            ...
            string formitem = string.Format(formdataTemplate, "myfile", usbArchive.FileName);
            ...
            string header = string.Format(headerTemplate, "myfile", usbArchive.FileName);

            byte[] headerbytes = System.Text.Encoding.UTF8.GetBytes(header);

            memStream.Write(headerbytes, 0, headerbytes.Length);

            byte[] fromUsb = usbArchive.LoadArchive();
            memStream.Write(fromUsb, 0, fromUsb.Length);
            memStream.Write(boundarybytes, 0, boundarybytes.Length);
