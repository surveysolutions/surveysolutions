...
namespace dbup
{
    ...
    {
        public static HbmMapping GetPlainMappingsForHQ()
        {
            ...
            return CompilePlainStoreMappings(mapper, mappingTypes);
        }


        public static HbmMapping GetPlainMappingsForDesigner()
        {
            var mapper = new ModelMapper();
        ...
        private static HbmMapping CompilePlainStoreMappings(ModelMapper mapper, IEnumerable<Type> mappingTypes)
        {
        ...
        public static HbmMapping GetReadSideForDesigner()
        {
            ...
            return CompileReadSideMappings(mapper, mappingTypes);
        }
        ...
        private static HbmMapping CompileReadSideMappings(ModelMapper mapper, IEnumerable<Type> mappingTypes)
        {
            mapper.AddMappings(mappingTypes);
            mapper.BeforeMapProperty += (inspector, member, customizer) =>
            {
