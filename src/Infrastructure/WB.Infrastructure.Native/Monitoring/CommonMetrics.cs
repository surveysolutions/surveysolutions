namespace WB.Infrastructure.Native.Monitoring
{
    ...
    {
        public static Counter WebInterviewConnection = new Counter("wb_webinterview_connections", "Number of times connection were open (open/closed), (review,takenew,web)", "action", "mode");
