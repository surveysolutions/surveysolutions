    ...
    public class M201903051455_AddIdentityTables : Migration
    {
        public override void Up()
        {
            Create.Table("AspNetRoles")
               .WithColumn("Id").AsGuid().PrimaryKey("PK_AspNetRoles").NotNullable()
            ...
            Create.Table("AspNetUserTokens")
                .WithColumn("UserId").AsGuid().PrimaryKey("PK_AspNetUserTokens").NotNullable()
            ...
            Create.Table("AspNetUsers")
               ...
               .WithColumn("CanImportOnHq").AsBoolean().WithDefaultValue(false).NotNullable()
            ...
            Create.Table("AspNetUserClaims")
              ...
              .WithColumn("ClaimType").AsString().Nullable()
              .WithColumn("ClaimValue").AsString().Nullable()
              .WithColumn("UserId").AsGuid().NotNullable().Indexed("IX_AspNetUserClaims_UserId")
