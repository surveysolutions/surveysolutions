...
using WB.UI.Capi.DataCollection.Settings;
using WB.UI.Capi.DataCollection.Syncronization.Update;
...
namespace WB.UI.Capi.DataCollection
{
    ...
    public class SettingsActivity : Activity
    {
        ...
        private void GetLocation()
        {
            ...
            this.geoservice.GetPositionAsync(20000, this.cancelSource.Token).ContinueWith((Task<Position> t) => this.RunOnUiThread(() =>
                {
