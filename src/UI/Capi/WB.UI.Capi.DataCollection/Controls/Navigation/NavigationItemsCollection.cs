...
namespace WB.UI.Capi.DataCollection.Controls.Navigation
{
    /// <summary>
    /// The navigation items collection.
    /// </summary>
    public class NavigationItemsCollection : List<NavigationItem>
    {
        ...
        {
            var intent = new Intent(this.context, typeof(DashboardActivity));
        ...
        {
            var intent = new Intent(this.context, typeof(SynchronizationActivity));
            intent.SetFlags(ActivityFlags.ReorderToFront);
            this.context.StartActivity(intent);
        ...
        {
            var intent = new Intent(this.context, typeof(LoginActivity));
            intent.SetFlags(ActivityFlags.ReorderToFront);
            this.context.StartActivity(intent);
        ...
        {
            var intent = new Intent(this.context, typeof(SettingsActivity));
            intent.SetFlags(ActivityFlags.ReorderToFront);
            this.context.StartActivity(intent);
