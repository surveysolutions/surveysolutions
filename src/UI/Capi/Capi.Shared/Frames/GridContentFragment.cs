    ...
    public abstract class GridContentFragment : AbstractScreenChangingFragment
    {
        ...
        public QuestionnaireGridViewModel Model
        {
            get
            {
                if (this.model == null)
                {
                    this.model = this.Questionnaire.Screens[InterviewItemId.Parse(this.Arguments.GetString(ScreenId))] as QuestionnaireGridViewModel;
                }
                return this.model;
            }
        }
        ...
        protected InterviewViewModel Questionnaire
        {
            get
            {
                ...
                {
                    this.questionnaire = GetInterviewViewModel(Guid.Parse(this.Arguments.GetString(QuestionnaireId)));
                }
