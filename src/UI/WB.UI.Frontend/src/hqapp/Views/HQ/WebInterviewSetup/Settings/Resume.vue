                ...
                <div class="costomization-block">
                    <div class="row-element mb-30">
                        ...
                        <div class="form-group"
                            :class="{ 'has-error': errors.resumeWelcome }">
                            <div class="field"
                    ...
                    <div class="row-element mb-30">
                        ...
                        <Field v-slot="{ field }"
                            name="resumeInvitationDescription"
                            :value="webInterviewPageMessages['resumeInvitation'].text">

                            <md-editor ref="resumeInvitation"
                                v-bind="field"
                    ...
                    <div class="row-element mb-30">
                        ...
                        <div class="form-group"
                            :class="{ 'has-error': errors.resumeButton }">
                            <div class="field"
