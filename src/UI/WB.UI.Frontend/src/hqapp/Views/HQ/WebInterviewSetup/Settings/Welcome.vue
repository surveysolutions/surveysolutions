                ...
                <div class="costomization-block">
                    <div class="row-element mb-30">
                        ...
                        <div class="form-group"
                            :class="{ 'has-error': errors.welcomeTextTitle }">
                            <div class="field"
                    ...
                    <div class="row-element mb-30">
                        ...
                        <Field v-slot="{ field }"
                            name="welcomeTextDescription"
                            :value="webInterviewPageMessages['invitation'].text">

                            <md-editor ref="welcomeTextDescription"
                                v-bind="field"
                    ...
                    <div class="row-element mb-30">
                        ...
                        <div class="form-group"
                            :class="{ 'has-error': errors.startNewButton }">
                            <div class="field"
