                                                ...
                                                <div class="row-element"
                                                    ...
                                                    <div class="form-group mb-30"
                                                        ...
                                                        <div class="field"
                                                            ...
                                                            <span class="help-block"
                                                                v-if="errors.passwordDescription">
                                                                {{ $t('WebInterviewSettings.FieldRequired') }}
                                                            </span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="preview email-block-unit">
                                            <div class="browser-mockup">
                                                <div class="email-example">
                                                    <table class="em-table email-example-table"
                                                        align="center"
                                                        border="0"
                                                        cellspacing="0"
                                                        cellpadding="0">
                    ...
                    <div style="padding-bottom: 20px">
                        <Form v-slot="{ errors, meta }"
                            ...
                            <div class="form-group mb-20">
                                <Field v-slot="{ field }"
                                    name="spamProtectionIsEnabled"
                                    :value="spamProtectionIsEnabled">
                            ...
                            <div class="form-group mb-20">
                                <Field v-slot="{ field }"
                                    ...
                                    :value="emailOnCompleteIsEnabled">
                                    <input class="checkbox-filter"
                                        v-bind="field"
                                        v-validate="''"
                                        name="emailOnComplete"
                            ...
                            <div class="form-group mb-20">
                                <Field v-slot="{ field }"
                                    name="attachAnswersInEmail"
                                    :value="attachAnswersInEmailIsEnabled">
                                    <input class="checkbox-filter"
                                        v-bind="field"
                                        v-validate="''"
                                        name="attachAnswersInEmail"
                                    ...
                                    <label for="attachAnswersInEmail">
                                        <span class="tick"></span>{{
                                            $t('WebInterviewSetup.AttachAnswersToCompleteEmail') }}
                                    </label>
                                </Field>
                            </div>
                            <div class="form-group mb-20">
                                <Field v-slot="{ field }"
                                    name="allowSwitchToCawiForInterviewer"
                                    :value="allowSwitchToCawiForInterviewerEnabled">
                                    <input class="checkbox-filter"
                                        v-bind="field"
                                        v-validate="''"
                                        name="allowSwitchToCawiForInterviewer"
                                    ...
                                    <label for="allowSwitchToCawiForInterviewer">
                                        <span class="tick"></span>{{
                                            $t('WebInterviewSetup.AllowSwitchToCawiForInterviewer')
                                        }}
                                    </label>
                                </Field>
                            </div>
                            <div class="form-group mb-20">
                                <Field v-slot="{ field }"
                                    name="allowTranscriptDownloading"
                                    :value="allowTranscriptDownloadingEnabled">
                                    <input class="checkbox-filter"
                                        v-bind="field"
                                        v-validate="''"
                                        name="allowTranscriptDownloading"
                                        data-vv-name="allowTranscriptDownloading"
                                        id="allowTranscriptDownloading"
                                        type="checkbox"
                            ...
                            <div class="notification-block mb-20">
                                <Field v-slot="{ field }"
                                    name="reminderAfterDaysIfNoResponse"
...
export default {
    ...
    beforeMount() {
        ...
        self.reminderAfterDaysIfPartialResponse =
            this.$config.model.reminderAfterDaysIfPartialResponse
        ...
        this.emailTemplates = map(
            ...
            (value, key) => {
                ...
                var passwordDescription =
                    custom == undefined ||
                        isNil(custom.passwordDescription) ||
    ...
    methods: {
        ...
        async saveAdditionalSettings() {
            var self = this
            self.$store.dispatch('showProgress')
            await this.$hq.WebInterviewSettings.updateAdditionalSettings(
                this.questionnaireId,
                this.spamProtectionIsEnabled,
                this.reminderAfterDaysIfNoResponse == 'null'
                    ? null
                    : this.reminderAfterDaysIfNoResponse,
                this.reminderAfterDaysIfPartialResponse == 'null'
                    ? null
        ...
        cancelAdditionalSettings() {
            ...
            this.reminderAfterDaysIfNoResponse =
                this.cancelReminderAfterDaysIfNoResponse
            this.reminderAfterDaysIfPartialResponse =
                this.cancelReminderAfterDaysIfPartialResponse
