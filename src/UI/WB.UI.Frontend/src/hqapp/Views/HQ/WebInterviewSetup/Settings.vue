<template>
    <HqLayout :mainClass="'interview-setup'"
        :title="$t('WebInterviewSettings.WebInterviewSetupFor_Title')">
        <div slot="headers">
            <ol class="breadcrumb">
                <li>
            ...
            <div class="col-md-12">
                ...
                <div class="welcome-page">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel"
                            class="tab-pane active page-preview-block"
                            id="welcome">
                            <form class=""
                                :data-vv-scope="'welcomePage'"
                                        ...
                                        <div class="row-element mb-30">
                                            ...
                                            <div class="form-group"
                                                ...
                                                <div class="field"
                                                    ...
                                                    <button type="button"
                                                        @click="webInterviewPageMessages['welcomeText'].text=''"
                                                        class="btn btn-link btn-clear">
                                                        <span></span>
                                                    </button>
                                                    <span class="help-block"
                                                        v-if="errors.first('welcomePage.welcomeTextTitle')">{{$t('WebInterviewSettings.FieldRequired')}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row-element mb-30">
                                        ...
                                        <div class="row-element mb-30">
                                            ...
                                            <div class="form-group"
                                                ...
                                                <div class="field"
                                                    ...
                                                    <button type="button"
                                                        @click="webInterviewPageMessages['resumeWelcome'].text=''"
                                                        class="btn btn-link btn-clear">
                                                        <span></span>
                                                    </button>
                                                    <span class="help-block"
                                        ...
                                        <div class="row-element mb-30">
                                            ...
                                            <div class="form-group"
                                                ...
                                                <div class="field"
                                                    ...
                                                    <button type="button"
                                                        @click="webInterviewPageMessages['webSurveyHeader'].text=''"
                                                        class="btn btn-link btn-clear">
                                                        <span></span>
                                                    </button>
                                                    <span class="help-block"
        ...
        <div class="row mb-05">
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <div class="tab-content">
                        <div v-for="emailTemplate in emailTemplates"
                            :key="emailTemplate.type"
                            :class="{active:emailTemplate.isActive}"
                            role="tabpanel"
                                        ...
                                        <div class="">
                                            ...
                                            <div class="row-element">
                                                ...
                                                <div class="form-group mb-30"
                                                    ...
                                                    <div class="field"
                                                        :class="{ 'answered': emailTemplate.subject }">
                                                        <input type="text"
                                                        ...
                                                        <span class="help-block"
                                                            v-if="errors.first('emailTemplateData' + emailTemplate.value + '.subject')">{{$t('WebInterviewSettings.FieldRequired')}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row-element mb-30"
                                            ...
                                            <div class="row-element">
                                                ...
                                                <div class="form-group mb-30"
                                                    ...
                                                    <div class="field"
                                                        ...
                                                        <button type="button"
                                                            @click="emailTemplate.message=null"
                                                            class="btn btn-link btn-clear">
                                                            <span></span>
                                                        </button>
                                                        <span class="help-block"
                                                            v-if="errors.first('emailTemplateData' + emailTemplate.value + '.message')">{{$t('WebInterviewSettings.FieldRequired')}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row-element"
                                                ...
                                                <div class="form-group mb-30"
                                                    ...
                                                    <div class="field"
                                                        ...
                                                        <span class="help-block"
                                                            v-if="errors.first('emailTemplateData' + emailTemplate.value + '.passwordDescription')">{{$t('WebInterviewSettings.FieldRequired')}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row-element"
                                                    ...
                                                    <tr>
                                                        <td style="border: 6px solid #E5E5E5;  padding: 50px 55px 115px; box-sizing: border-box;">
                                                            <table border="0"
                                                                ...
                                                                <tr>
                                                                    <td style="font-size: 24px; line-height: 30px; color: #727272; font-weight: bold; white-space: pre-line;">
                ...
                <form v-on:submit.prevent="dummy"
                    ...
                    <div class="form-group mb-20">
                        <input class="checkbox-filter"
                            v-validate="''"
                            data-vv-name="spamProtectionIsEnabled"
                            id="Captcha"
                            type="checkbox"
                    ...
                    <div class="notification-block mb-20">
                        ...
                        <select class="selectpicker"
                            v-validate="'required'"
                            tabindex="-98"
                            ref="reminderAfterDaysIfNoResponse"
                    ...
                    <div class="">
                        <button type="submit"
                            :disabled="!isDirty('$additionalSettings')"
                        ...
                        <button type="submit"
                            :disabled="!isDirty('$additionalSettings')"
                            @click="cancelAdditionalSettings()"
                            class="btn btn-md btn-link">
                            {{$t('WebInterviewSettings.Cancel')}}
                        </button>
                    </div>
            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <a :href="this.$config.model.surveySetupUrl"
                        class="btn btn-lg back-link mb-1"
                        role="button">
    ...
    methods: {
        ...
        previewMessage(emailTemplate) {
            ...
            return text
                ...
                .replace(/%[A-Za-z0-9_]+:barcode%/g, '<img src="data:image/png;base64,"/>')
                .replace(/%[A-Za-z0-9_]+:qrcode%/g, '<img src="data:image/png;base64,"/>')
        },
        dummy() {
            return false
        },
