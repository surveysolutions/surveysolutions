                            ...
                            >
                                ...
                                >
                                    <div class="email-block d-flex mb-30">
                                        <div
                                            class="costomization-block email-block-unit"
                                        >
                                            <div class="">
                                        ...
                                        <div class="preview email-block-unit">
                                            <div class="browser-mockup">
                                                <div class="email-example">
                                                    <table
                                                        class="em-table email-example-table"
                                                        align="center"
                                                        border="0"
                                                        cellspacing="0"
                                                        cellpadding="0"
                        ...
                        >
                            ...
                            <div class="form-group mb-20">
                                <input
                                    ...
                                    type="checkbox"
                                    v-model="
                                        allowSwitchToCawiForInterviewerEnabled
                                    "
                                />
