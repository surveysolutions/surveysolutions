                            ...
                            <div class="buttons-container">
                                <div class="dropdown aside-menu">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a :href="config.downloadLinksUrl + '/' + config.questionnaireIdentity.id">
                                                {{
                                        ...
                                        <li>
                                            <a :href="config.sendInvitationsUrl + '/' + config.questionnaireIdentity.id">
                                                {{
                            ...
                            <li role="presentation">
                                <a href="#complete" @click="setPageActive('completeNoteToSupervisor')"
                                    aria-controls="complete" role="tab" data-toggle="tab">{{
                                        $t('WebInterviewSettings.CompletePage') }}</a>
                            </li>
                            <li role="presentation">
                                        ...
                                        <div class="costomization-block email-block-unit">
                                            <div class="">
                                                ...
                                                <div class="row-element mb-30"
                                                    ...
                                                    <p>{{ $t('WebInterviewSettings.InterviewDataInsertInTextDescription') }}
                                                    </p>
                                                    <p>{{ $t('WebInterviewSettings.InterviewDataInsertBarcodeDescription')
                                                    }}
                                                    </p>
                                                    <p>{{ $t('WebInterviewSettings.InterviewDataInsertQrCodeDescription') }}
                                                    </p>
                                                </div>
                                                <div class="row-element">
                                                    <div class="h5">
