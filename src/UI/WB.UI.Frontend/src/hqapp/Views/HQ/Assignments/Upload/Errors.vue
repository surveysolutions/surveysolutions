    ...
    <HqLayout :hasFilter="false">
        ...
        <div class="row">
            <div class="col-sm-7 col-xs-12 action-block">
                ...
                <h3
                    class="error-text"
                    v-if="verificationErrors.length == 1">{{$t('BatchUpload.SingleErrorFound')}}</h3>
                <h3
                    class="error-text"
                    v-else>{{$t('BatchUpload.MultipleErrorsWereFound', {count: verificationErrors.length})}}</h3>
                ...
                <div class="error-block"
                    ...
                    <div v-for="(reference, index) in error.references"
                        ...
                        <p v-if="!isEmptyText(reference.content)">
                            ...
                            (
                            <span
                                v-if="!isEmptyText(reference.column)">{{$t('BatchUpload.Column')}}: {{reference.column}},</span>
