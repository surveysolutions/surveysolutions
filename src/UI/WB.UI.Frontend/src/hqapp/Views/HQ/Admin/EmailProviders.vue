<template>
    <HqLayout :fixedWidth="true" :title="$t('Pages.EmailProvidersTitle')">
        <div slot="headers">
            ...
            <div class="col-md-12">
                <form class="form-container" data-vv-scope="settings">
                    ...
                    <div class="form-inline">
                        ...
                        >
                            <label class="h5">{{ $t('Settings.EmailProvider_SenderAddress')}}</label>
                            <div class="field" :class="{ 'answered': senderAddress }">
                                ...
                                >{{ $t('Settings.EmailProvider_SenderHelp')}}</span>
                                <span
                                    class="help-block"
                                >{{ errors.first('settings.senderAddress') }}</span>
                            </div>
                        </div>
                        <div
                            class="form-group"
                        ...
                        >
                            <label class="h5">{{ $t('Settings.EmailProvider_ReplyAddress')}}</label>
                            <div class="field" :class="{ 'answered': replyAddress }">
                                ...
                                <span
                                    class="gray-text help-block"
                                >{{ $t('Settings.EmailProvider_ReplyAddressHelp')}}</span>
                    ...
                    >
                        <label class="h5">{{ $t('Settings.EmailProvider_SenderName')}}</label>
                    ...
                    >
                        <label class="h5">{{ $t('Settings.EmailProvider_Address')}}</label>
                        <div class="field" :class="{ 'answered': address }">
                            ...
                            <span
                                class="gray-text help-block"
                            >{{ $t('Settings.EmailProvider_AddressHelp')}}</span>
                                ...
                                <div class="wrapper">
                                    <p>
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                        >{{$t('Settings.EmailProvider_HelpLinkText')}}</a>
                                    </p>
                                    <div
                                        class="form-group"
                                    ...
                                    >
                                        <label
                                            class="h5"
                                        >{{ $t('Settings.EmailProvider_AwsAccessKeyId')}}</label>
                                        <div class="field" :class="{ 'answered': awsAccessKeyId }">
                                            ...
                                            <span
                                                class="help-block"
                                            >{{ errors.first('settings.awsAccessKeyId') }}</span>
                                        </div>
                                    </div>
                                    <div
                                        class="form-group"
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <span
                                                class="help-block"
                                            >{{ errors.first('settings.awsSecretAccessKey') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="extended-block" v-if="provider === 'sendgrid'">
                                <div class="wrapper">
                                    ...
                                    >
                                        <label
                                            class="h5"
                                        >{{ $t('Settings.EmailProvider_SendGridApiKey')}}</label>
                                        <div class="field" :class="{ 'answered': sendGridApiKey }">
                                            ...
                                            <span
                                                class="help-block"
                                            >{{ errors.first('settings.sendGridApiKey') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <p
                        class="text-info"
                        v-if="isFormDirty"
                    >Save current changes and send yourself a test email to verify that the bulk email service is functional</p>
                ...
                >
                    ...
                    <div class="form-group">
                        <button
                            ...
                            @click="sendTestEmail"
                        >{{ $t('Settings.EmailProvider_SendTestEmail')}}</button>
                    </div>
                    <p
                        class="text-success"
                        v-if="sendEmailResult"
                    >{{$t('Settings.EmailProvider_SendTestEmailResult')}}</p>
