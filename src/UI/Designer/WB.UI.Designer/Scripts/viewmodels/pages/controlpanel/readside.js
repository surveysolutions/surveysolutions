Designer.VM.ControlPanel.ReadSide = function (rebuildApiUrl, eventHandlersApiUrl, updateRebuildStatusApiUrl, stopRebuildApiUrl) {
    Designer.VM.ControlPanel.ReadSide.superclass.constructor.apply(this, arguments);
    ...
    self.rebuildByAll = ko.computed(function () {
        return self.rebuildByType() === Designer.VM.ControlPanel.ReadSide.RebuildReadSideType.All;
    });
    self.rebuildByHandlers = ko.computed(function () {
        return self.rebuildByType() === Designer.VM.ControlPanel.ReadSide.RebuildReadSideType.ByHandlers;
    });
    self.rebuildByHandlersAndEventSource = ko.computed(function () {
        return self.rebuildByType() === Designer.VM.ControlPanel.ReadSide.RebuildReadSideType.ByHandlersAndEventSource;
    });
...
Designer.VM.ControlPanel.ReadSide.RebuildReadSideType = { All: 0, ByHandlers: 1, ByHandlersAndEventSource: 2 };

Designer.Framework.Classes.inherit(Designer.VM.ControlPanel.ReadSide, Designer.VM.BasePage);