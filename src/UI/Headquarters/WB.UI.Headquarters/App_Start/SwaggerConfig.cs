                ...
                .EnableSwagger("docs/{apiVersion}/swagger", c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Survey Solutions API");
                        ...
                        c.IncludeXmlComments(string.Format(@"{0}\bin\WB.UI.Headquarters.XML", System.AppDomain.CurrentDomain.BaseDirectory));
