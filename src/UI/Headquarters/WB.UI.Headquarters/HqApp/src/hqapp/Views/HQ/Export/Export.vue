          ...
          <form v-if="!exportServiceIsUnavailable">
            ...
            <div class="mb-30" v-if="hasInterviews || hasBinaryData || questionnaireVersion">
                ...
                <div class="radio-btn-row" v-if="hasInterviews">
                  ...
                  <label for="surveyData" class="" >
                    ...
                    <span class="format-data Binary">{{$t('DataExport.DataType_MainSurveyData')}}</span>
                  </label>
                </div>
                <div class="radio-btn-row" v-if="hasInterviews && hasBinaryData">
                  ...
                  <label for="binaryData">
                    <span class="tick"></span>
                    <span class="format-data Binary">{{$t('DataExport.DataType_Binary')}}</span>
                  </label>
                </div>
                ...
                <div class="radio-btn-row" v-if="hasInterviews">
                  ...
                  <label for="paraData">
                    <span class="tick"></span>
                    <span class="format-data Tabular">{{$t('DataExport.DataType_Paradata')}}</span>
                  </label>
                </div>
            </div>
            <div class="mb-30" v-if="dataType == 'surveyData'">
                ...
                <div class="radio-btn-row">
                  ...
                  <label for="separated">
                    <span class="tick"></span>
                    <span class="format-data Tabular">{{$t('DataExport.DataFormat_Tab')}}</span>
                  </label>
                </div>
                <div class="radio-btn-row">
                  ...
                  <label for="Stata" class="">
                    <span class="tick"></span>
                    <span class="format-data STATA">{{$t('DataExport.DataFormat_Stata')}}</span>
                  </label>
                </div>
                <div class="radio-btn-row">
                  ...
                  <label for="Spss">
                    <span class="tick"></span>
                    <span class="format-data SPSS">{{$t('DataExport.DataFormat_Spss')}}</span>
                  </label>
                </div>
            </div>
            <div class="mb-30" v-if="canExportExternally">
                ...
                <div class="radio-btn-row">
                  ...
                  <label for="download">
                    <span class="tick"></span>
                    <span class="export-destination">{{$t('DataExport.DataDestination_Zip')}}</span>
                  </label>
                </div>
                <div class="radio-btn-row" v-if="isDropboxSetUp">
                  ...
                  <label for="onedrive">
                    <span class="tick"></span>
                    <span class="export-destination OneDrive">{{$t('DataExport.DataDestination_OneDrive')}}</span>
                  </label>
                </div>
                <div class="radio-btn-row" v-if="isDropboxSetUp">
                  ...
                  <label for="dropbox">
                    <span class="tick"></span>
                    <span class="export-destination Dropbox">{{$t('DataExport.DataDestination_Dropbox')}}</span>
                  </label>
                </div>
                <div class="radio-btn-row" v-if="isGoogleDriveSetUp">
                  ...
                  <label for="googleDrive">
                    <span class="tick"></span>
                    <span class="export-destination GoogleDrive">{{$t('DataExport.DataDestination_GoogleDrive')}}</span>
                  </label>
                </div>
            </div>
            <div class="mb-30">
                <div class="structure-block">
                    <button type="button" class="btn btn-success" @click="queueExport">{{$t('DataExport.AddToQueue')}}</button>
                    <button type="button" class="btn btn-lg btn-link" @click="resetForm">{{$t('Strings.Cancel')}}</button>
                </div>
            </div>
          </form>
        </div>
