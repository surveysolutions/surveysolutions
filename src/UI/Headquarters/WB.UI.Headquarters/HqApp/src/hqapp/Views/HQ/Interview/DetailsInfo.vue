...
<template>
    <div class="panel panel-details" :class="{ 'contains-action-buttons': showRejectButton || showUnapproveButton || showApproveButton }">
        <div class="panel-body clearfix">
            ...
            <div class="questionnaire-details-actions clearfix" v-if="canChangeLanguage || showRejectButton || showUnapproveButton || showApproveButton">
