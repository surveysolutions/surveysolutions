...
namespace WB.UI.Headquarters.Resources {
    ...
    public class Assignments {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Specify maximum number of interviews to be generated for that assignment (Quantity). Permitted values: -1 is for Unlimited assignment, 0 is for Empty assignment, numbers for assigment size.
        /// </summary>
