...
exports.default = {
    ...
    watch: {
        interviewFilters: function interviewFilters(newFilters) {
            var filters = JSON.parse(newFilters);
            console.log(filters);
        }
    },
    mounted: function mounted() {
