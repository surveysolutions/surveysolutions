        ...
        <div class="question-unit">
            ...
            <div class="options-group">
                <div class="radio" v-for="option in $me.options">
                    <div class="field">
                        <input class="wb-radio" type="radio" :name="$me.id + '_' + option.value" :id="$me.id + '_' + option.value + '_yes'" :checked="isYesChecked(option.value)" value="true"  v-model="answer" />
    ...
    export default {
        ...
        computed: {
            answer: {
                ...
                set(value) {
                    ...
                    {
                        this.$store.dispatch("answerYesNoQuestion", { questionId: this.$me.id, answer: value })
                        return;
                    }
        ...
        methods: {
            ...
            isYesChecked(answerValue) {
                var answerObj = $.grep(this.$me.answer, function(e){ return e.value == answerValue; });
