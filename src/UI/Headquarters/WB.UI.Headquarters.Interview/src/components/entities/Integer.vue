            ...
            <div class="options-group">
                <div class="form-group">
                    <div class="field answered">
                        <input type="text" autocomplete="off" inputmode="numeric" pattern="[0-9\-]*" class="field-to-fill" placeholder="Enter number" title="Enter number" :value="$me.answer" v-blurOnEnterKey @blur="answerIntegerQuestion"
