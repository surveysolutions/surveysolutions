    ...
    public abstract class ContentFrameAdapter : FragmentStatePagerAdapter
    {
            ...
            : base(fm)
        {
            ...
            this.screensHolder = (screenId.HasValue
                                     ? questionnaire.Screens[InterviewItemId.ConvertInterviewItemId(screenId.Value)].Siblings
        ...
        public override Fragment GetItem(int position)
        {
            ...
            else
            {
                ...
                var model = this.questionnaire.Screens[InterviewItemId.ConvertInterviewItemId(param)];
        ...
        public void UpdateScreenData(InterviewItemId? newScreenId)
        {
            ...
            this.screensHolder = this.questionnaire.Screens[InterviewItemId.ConvertInterviewItemId(screenIdNotNull)].Siblings.ToList();
