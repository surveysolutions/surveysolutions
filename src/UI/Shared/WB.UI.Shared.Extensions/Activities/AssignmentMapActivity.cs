...
public class AssignmentMapActivity : MarkersMapActivity<AssignmentMapViewModel, AssignmentMapViewModelArgs>
{
    ...
    private void ClickedMenuButton(object sender, EventArgs e)
    {
        ...
        customMenuItems.Add(new CustomMenuItem(UIResources.MenuItem_Title_CreateInterview, () => this.ViewModel.CreateInterviewCommand.Execute(), Resource.Drawable.icon_create_interview));
