...
{
    public class InstantAutoCompleteTextViewOnFocusChangeBinding : BaseBinding<InstantAutoCompleteTextView, ICommand>
    {
        private ICommand command;
        private IDisposable subscription;

        public InstantAutoCompleteTextViewOnFocusChangeBinding(InstantAutoCompleteTextView androidControl) : base(androidControl)
        {
        }
        ...
        {
            this.command?.Execute(e.HasFocus);
        }
