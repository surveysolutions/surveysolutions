...
namespace WB.UI.Shared.Enumerator.CustomServices.AreaEditor
{
    ...
    public class AreaViewEditActivity : Activity
    {
        ...
        private async Task StartEditor()
        {
            ...
            AreaViewEditActivity.OnAreaEditCompleted(new AreaEditorResult()
            {
                Area = result?.ToJson()
        ...
        private void OnMapSelected(object sender, PopupMenu.MenuItemClickEventArgs e)
        {
            ...
            {
                this.mapViewModel.UpdateBaseMap(maps[selectedNavigationType]);
            }
        }
...
/*            var ButtonCancel = new Button(this);
            ...
            layout.AddView(startLocatorButton, layoutParamsButtons);
...
//        }
        ...
        private void Cancel()
        {
            AreaViewEditActivity.OnAreaEditCompleted((AreaEditorResult)null);
            this.Finish();
        }
    }
}