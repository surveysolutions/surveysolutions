    ...
    >
        ...
        >
            <div class="item-text">
                ...
                ></span-->
                <span v-text="item.variableData.label"></span>
            </div>
