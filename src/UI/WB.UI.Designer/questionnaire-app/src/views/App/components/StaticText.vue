        ...
        <div class="form-holder">
            ...
            <div class="form-group">
                ...
                <div class="pseudo-form-control">
                    <div>
                        <ExpressionEditor id="edit-static-text-highlight" v-model:value="activeStaticText.text" />
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="row" v-show="doesStaticTextSupportEnablementConditions() &&
                ...
                <div class="form-group col-xs-11">
                    <div class="enabling-group-marker" :class="{ 'hide-if-disabled': activeStaticText.hideIfDisabled }">
                    </div>
                ...
                <div class="form-group col-xs-1">
                    <button type="button" class="btn cross instructions-cross"
                        @click="showEnablingConditions = false; activeStaticText.enablementCondition = ''; activeStaticText.hideIfDisabled = false; dirty = false;"></button>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        doesStaticTextSupportEnablementConditions() {
            return this.activeStaticText && !this.activeStaticText.parentIsCover;
        },
