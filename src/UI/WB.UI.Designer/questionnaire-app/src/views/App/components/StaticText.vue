<template>
    ...
    >
        <div
            ...
            class="ng-cloak"
            v-show="shouldUserSeeReloadDetailsPromt"
        >
            <div class="inner">
                ...
                <a
                    ...
                    v-t="{ path: 'QuestionnaireEditor.QuestionClickReload' }"
                ></a>
            </div>
        </div>
        <div class="form-holder">
            ...
            >
                <button
                    ...
                    @click="showEnablingConditions = true"
                >
            ...
            >
                <div class="form-group col-xs-11">
                    ...
                    <div class="pseudo-form-control">
                        <ExpressionEditor
                            v-model="activeStaticText.enablementCondition"
                        ></ExpressionEditor>
                    </div>
                </div>
            ...
            <div
                ...
                v-for="(validation,
                index) in activeStaticText.validationConditions"
            ...
            >
                ...
                <label :for="'cb-isWarning' + index"
                    ><span></span
                    >{{ $t('QuestionnaireEditor.IsWarning') }}</label
                >
        ...
        <div class="form-buttons-holder">
            ...
            <div class="pull-right">
                <button
                    ...
                    class="btn btn-lg btn-link"
                    @click="toggleComments(activeStaticText)"
                    unsaved-warning-clear
                >
