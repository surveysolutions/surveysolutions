...
namespace WB.UI.Designer.Resources {
    ...
    public class AccountResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Please follow instructions sent to provided email ({0}) to confirm email change..
        /// </summary>
        public static string EmailChangeShouldBeConfirmed {
            get {
                return ResourceManager.GetString("EmailChangeShouldBeConfirmed", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Pending update to {0}.
        /// </summary>
        public static string PendingEmailUpdate {
            get {
