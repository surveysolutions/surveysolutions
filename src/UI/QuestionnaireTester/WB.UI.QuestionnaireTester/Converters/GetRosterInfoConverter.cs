...
{
    public class GetRosterInfoConverter : MvxValueConverter<RosterItemViewModel, string>
    {
        protected override string Convert(RosterItemViewModel value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            string subGroupsText = value.SubgroupsCount == 0
                ? (string) UIResources.Interview_Group_NoSubgroups
