...
namespace WB.UI.QuestionnaireTester
{
    ...
    public class HomeActivity : MvxSimpleBindingActivity
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            var template = ServiceLocator.Current.GetInstance<IJsonUtils>().Deserrialize<QuestionnaireDocument>(templateContent);
            ServiceLocator.Current.GetInstance<ICommandService>().Execute(new ImportFromDesignerForTester(template));
