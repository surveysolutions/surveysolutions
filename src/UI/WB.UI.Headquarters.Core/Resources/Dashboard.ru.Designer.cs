...
namespace WB.UI.Headquarters.Resources {
    ...
    public class Dashboard_ru {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Открытые переменные.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Просмотр опросника.
        /// </summary>
        public static string QuestionnairePreview {
            get {
                return ResourceManager.GetString("QuestionnairePreview", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Сохранить документ опросника.
        /// </summary>
        public static string SaveQuestionnaire {
            get {
                return ResourceManager.GetString("SaveQuestionnaire", resourceCulture);
            }
        }
