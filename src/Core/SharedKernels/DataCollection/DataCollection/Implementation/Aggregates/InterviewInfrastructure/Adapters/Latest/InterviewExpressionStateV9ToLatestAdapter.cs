...
{
    public class InterviewExpressionStateV9ToLatestAdapter : ILatestInterviewExpressionState
    {
        private readonly IInterviewExpressionStateV9 adaptee;

        public InterviewExpressionStateV9ToLatestAdapter(IInterviewExpressionStateV9 adaptee)
        {
            this.adaptee = adaptee;
        }

        public static ILatestInterviewExpressionState AdaptIfNeeded(IInterviewExpressionStateV9 adaptee)
            => adaptee as ILatestInterviewExpressionState ?? new InterviewExpressionStateV9ToLatestAdapter(adaptee);
        ...
        {
            return this.adaptee.ProcessVariables();
        }

        public void DisableVariables(IEnumerable<Identity> variablesToDisable)
        {
           this.adaptee.DisableVariables(variablesToDisable);
        }
        ...
        {
            this.adaptee.SerVariablePreviousValue(variableId,value);
        }
        ...
        private ILatestInterviewExpressionState Clone() => new InterviewExpressionStateV9ToLatestAdapter(this.adaptee.Clone());
    }
}