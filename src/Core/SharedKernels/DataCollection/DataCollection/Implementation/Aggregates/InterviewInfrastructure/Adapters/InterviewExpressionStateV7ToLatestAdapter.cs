...
namespace WB.Core.SharedKernels.DataCollection.Implementation.Aggregates.Adapters
{
    public class InterviewExpressionStateV7ToLatestAdapter: ILatestInterviewExpressionState
    {
        private readonly IInterviewExpressionStateV7 interviewExpressionState;

        public InterviewExpressionStateV7ToLatestAdapter(IInterviewExpressionStateV7 interviewExpressionState)
        {
        ...
        {
            return this.interviewExpressionState.ProcessLinkedQuestionFilters();
        }

        public bool AreLinkedQuestionsSupported()
        {
            return this.interviewExpressionState.AreLinkedQuestionsSupported();
        }
        ...
        {
            return new InterviewExpressionStateV7ToLatestAdapter(this.interviewExpressionState.Clone());
        }
