...
namespace WB.Core.SharedKernels.DataCollection.Views.Questionnaire
{
    ...
    {
        public RosterScopeDescription(Guid scopeId, string scopeName, RosterScopeType scopeType, Dictionary<Guid, RosterTitleQuestionDescription> rosterIdToRosterTitleQuestionIdMap, Dictionary<Guid, Guid[]> rosterIdToRosterVectorMap)
        {
