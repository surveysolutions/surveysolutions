...
namespace WB.Core.SharedKernels.DataCollection.Implementation.Aggregates.Snapshots
{
    internal class InterviewState
    {
        public InterviewState(Guid questionnaireId, long questionnaireVersion, InterviewStatus status,
            Dictionary<string, object> answersSupportedInExpressions, Dictionary<string, Tuple<Interview.Identity, int[]>> linkedSingleOptionAnswers,
            Dictionary<string, Tuple<Interview.Identity, int[][]>> linkedMultipleOptionsAnswers, HashSet<string> answeredQuestions,
        ...
        public Dictionary<string, Tuple<Interview.Identity, int[]>> LinkedSingleOptionAnswers { get; private set; }
        public Dictionary<string, Tuple<Interview.Identity, int[][]>> LinkedMultipleOptionsAnswers { get; private set; }
