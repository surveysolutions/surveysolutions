...
namespace WB.Core.SharedKernels.Enumerator.Properties {
    ...
    public class EnumeratorUIResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Received unexpected data. Either address is invalid or communication channel is affected by firewall, load balancer or other proxy. Please assure you are using compatible version of application. Please contact your server administrator..
        /// </summary>
        public static string UnknownResponseSource {
            get {
                return ResourceManager.GetString("UnknownResponseSource", resourceCulture);
            }
        }
