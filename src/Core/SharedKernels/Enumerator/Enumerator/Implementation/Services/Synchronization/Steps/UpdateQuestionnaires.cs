...
{
    public class UpdateQuestionnaires : SynchronizationStep
    {
        ...
        public UpdateQuestionnaires(ISynchronizationService synchronizationService, IInterviewerQuestionnaireAccessor questionnairesAccessor, IPlainStorage<InterviewView> interviewViewRepository,
