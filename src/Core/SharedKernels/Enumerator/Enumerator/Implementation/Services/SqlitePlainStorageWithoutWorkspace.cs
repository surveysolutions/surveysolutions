...
{
    public class SqlitePlainStorageWithoutWorkspace<TEntity> : SqlitePlainStorageWithoutWorkspace<TEntity, string>,
        IPlainStorage<TEntity>
        where TEntity : class, IPlainStorageEntity, new()
    {
        public SqlitePlainStorageWithoutWorkspace(ILogger logger, IFileSystemAccessor fileSystemAccessor,
            SqliteSettings settings)
            : base(logger, fileSystemAccessor, settings)
        {
        }

        public SqlitePlainStorageWithoutWorkspace(SQLiteConnectionWithLock storage, ILogger logger) : base(storage,
            logger)
        {
        }
    }

    public class SqlitePlainStorageWithoutWorkspace<TEntity, TKey> : IPlainStorage<TEntity, TKey>
        where TEntity : class, IPlainStorageEntity<TKey>, new()
    {
        ...
        public SqlitePlainStorageWithoutWorkspace(ILogger logger,
        ...
        public SqlitePlainStorageWithoutWorkspace(SQLiteConnectionWithLock storage, ILogger logger)
        {
