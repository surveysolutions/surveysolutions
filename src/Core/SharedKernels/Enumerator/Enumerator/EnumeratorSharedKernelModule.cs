    ...
    public class EnumeratorSharedKernelModule : NinjectModule
    {
        public override void Load()
        {
            ...
            CommandRegistry
                ...
                .Handles<AnswerAreaQuestionCommand>(command => command.InterviewId, (command, aggregate) => aggregate.AnswerAreaQuestion(command.UserId, command.QuestionId, command.RosterVector, command.AnswerTime, command.Answer))
