...
namespace WB.Core.SharedKernels.SurveyManagement.Implementation.Services.Sql
{
    internal class ExportedDataAccessor : IExportedDataAccessor
    {
        ...
        private const string interviewComments = "interview_comments";
        ...
        public string CommentsTableName { get { return interviewComments; } }
        ...
        public List<string> CommentsFileColumns { get; private set; }
