...
namespace WB.Core.SharedKernels.SurveyManagement.Views.DataExport
{
    ...
    {
        public InterviewDataExportView(Guid interviewId, Guid templateId, long templateVersion, InterviewDataExportLevelView[] levels, InterviewExportedAction action)
        {
