...
namespace WB.Core.BoundedContexts.Designer.ValueObjects
{
    public class QuestionnaireVerificationMessage
    {
        ...
        public static QuestionnaireVerificationMessage Error(string code, string message, string translationName = "", params QuestionnaireNodeReference[] references)
            => new QuestionnaireVerificationMessage(code, message, null, VerificationMessageLevel.General, translationName, references);

        public static QuestionnaireVerificationMessage Error(string code, string message,params QuestionnaireNodeReference[] references)
            => new QuestionnaireVerificationMessage(code, message, null, VerificationMessageLevel.General, null, references);

        public static QuestionnaireVerificationMessage Error(string code, string message, IEnumerable<string> compilationErrorMessages, params QuestionnaireNodeReference[] references)
        ...
        public static QuestionnaireVerificationMessage Warning(string code, string message, params QuestionnaireNodeReference[] references)
            => new QuestionnaireVerificationMessage(code, message, null, VerificationMessageLevel.Warning, null, references);

        public static QuestionnaireVerificationMessage Critical(string code, string message, params QuestionnaireNodeReference[] references)
            ...
            IEnumerable<QuestionnaireNodeReference> references)
        {
            ...
            this.References = (references ?? Enumerable.Empty<QuestionnaireNodeReference>()).ToReadOnlyCollection();
        }
        ...
        public IReadOnlyCollection<QuestionnaireNodeReference> References { get; }
