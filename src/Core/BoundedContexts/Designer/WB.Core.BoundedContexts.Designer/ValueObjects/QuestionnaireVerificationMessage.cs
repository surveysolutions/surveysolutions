...
namespace WB.Core.BoundedContexts.Designer.ValueObjects
{
    public class QuestionnaireVerificationMessage
    {
        ...
        public static QuestionnaireVerificationMessage Error(string code, string message, IEnumerable<string> compilationErrorMessages, params QuestionnaireEntityReference[] references)
        ...
        public static QuestionnaireVerificationMessage Warning(string code, string message, params QuestionnaireEntityReference[] references)
            ...
            IEnumerable<QuestionnaireEntityReference> references)
        {
            ...
            this.References = (references ?? Enumerable.Empty<QuestionnaireEntityReference>()).ToReadOnlyCollection();
        }
        ...
        public static bool HaveSameCodeAndReferencesAndTranslation(QuestionnaireVerificationMessage? x,
            QuestionnaireVerificationMessage? y)
        {
            ...
            return x.Code == y.Code
                   ...
                   && x.TranslationName == y.TranslationName;
        }
