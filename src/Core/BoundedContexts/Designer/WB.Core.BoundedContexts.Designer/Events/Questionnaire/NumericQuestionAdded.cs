...
namespace WB.Core.BoundedContexts.Designer.Events.Questionnaire
{
    ...
    {
        public NumericQuestionAdded(Guid responsibleId, string conditionExpression, bool featured, string instructions, bool capital, Guid publicKey, string questionText, 
            ...
            Guid groupPublicKey) : base(responsibleId, conditionExpression, featured, instructions, capital, publicKey, questionText, questionScope, stataExportCaption, variableLabel, 
