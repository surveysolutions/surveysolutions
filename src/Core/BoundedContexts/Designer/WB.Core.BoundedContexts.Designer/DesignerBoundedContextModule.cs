    ...
    public class DesignerBoundedContextModule : IAppModule
    {
        ...
        public Task InitAsync(IServiceLocator serviceLocator, UnderConstructionInfo status)
        {
            CommandRegistry
                ...
                .Handles<SwitchToTranslation>(aggregate => aggregate.SwitchToTranslation, config => config.PostProcessBy<ListViewPostProcessor>().PostProcessBy<HistoryPostProcessor>())
                // Categories
