    ...
    public class DesignerBoundedContextModule : IModule
    {
        ...
        public Task Init(IServiceLocator serviceLocator, UnderConstructionInfo status)
        {
            ...
            CommandRegistry
                ...
                .Handles<ReplaceOptionsWithClassification>((command, aggregate) => aggregate.ReplaceOptionsWithClassification(command), config => config.PostProcessBy<ListViewPostProcessor>())
