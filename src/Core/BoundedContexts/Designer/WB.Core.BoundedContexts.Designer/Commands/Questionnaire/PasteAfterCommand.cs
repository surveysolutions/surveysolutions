...
{
    public class PasteAfterCommand : QuestionnaireEntityCommand
    {
        public PasteAfterCommand(Guid questionnaireId, Guid entityId, Guid itemToPasteAfterId, Guid sourceQuestionnaireId, Guid sourceItemId, Guid responsibleId)
