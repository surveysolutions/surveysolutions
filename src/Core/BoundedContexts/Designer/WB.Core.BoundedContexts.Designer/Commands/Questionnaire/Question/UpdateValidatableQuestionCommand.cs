...
namespace WB.Core.BoundedContexts.Designer.Commands.Questionnaire.Question
{
    ...
    {
        public UpdateValidatableQuestionCommand(Guid responsibleId, Guid questionnaireId, Guid questionId, CommonQuestionParameters commonQuestionParameters, List<ValidationCondition> validationConditions)
