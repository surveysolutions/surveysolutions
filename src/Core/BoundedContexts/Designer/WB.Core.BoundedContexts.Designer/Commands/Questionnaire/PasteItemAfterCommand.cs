...
{
    public class PasteItemAfterCommand : QuestionnaireEntityCommand
    {
        public PasteItemAfterCommand(Guid questionnaireId, Guid entityId, Guid itemToPasteAfterId, Guid sourceQuestionnaireId, Guid sourceItemId, Guid responsibleId)
