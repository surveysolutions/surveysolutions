...
namespace WB.Core.BoundedContexts.Designer.Commands.Questionnaire.Group
{
    ...
    public class AddGroup : FullGroupDataCommand
    {
        public AddGroup(Guid questionnaireId, Guid groupId, Guid responsibleId,
            ...
            Guid? parentGroupId, bool isRoster, bool isFlatMode, RosterSizeSourceType rosterSizeSource, FixedRosterTitleItem[] fixedRosterTitles, Guid? rosterTitleQuestionId,
            int? index = null)
            : base(
                ...
                fixedRosterTitles, rosterTitleQuestionId, isFlatMode)
        {
