...
namespace WB.Core.BoundedContexts.Interviewer.Implementation.Services
{
    public class OfflineSynchronizationService : IOfflineSynchronizationService
    {
        ...
        public async Task<List<QuestionnaireSettingsApiView>> GetServerQuestionnairesSettingsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return response.QuestionnairesSettings;
        }
        ...
        public Task<RestStreamResult> GetMapContentStream(string mapName, CancellationToken token = default, long offset = 0)
        {
