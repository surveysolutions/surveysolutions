...
namespace WB.Core.BoundedContexts.Interviewer.Views.Dashboard
{
    public class DashboardViewModel : BaseOfflineSyncViewModel<DashboardViewModelArgs>
    {
        ...
        private void SelectTypeOfInterviewsByInterviewId(Guid? lastVisitedInterviewId)
        {
            ...
            this.TypeOfInterviews = interviewView.Status switch
            {
                InterviewStatus.RejectedBySupervisor => this.RejectedInterviews.InterviewStatus,
                InterviewStatus.Completed => this.CompletedInterviews.InterviewStatus,
                InterviewStatus.WebInterview => GroupStatus.WebInterview,
                InterviewStatus.InterviewerAssigned => this.StartedInterviews.InterviewStatus,
                InterviewStatus.Restarted => this.StartedInterviews.InterviewStatus,
