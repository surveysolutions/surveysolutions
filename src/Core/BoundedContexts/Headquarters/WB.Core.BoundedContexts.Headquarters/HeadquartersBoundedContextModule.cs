    ...
    public class HeadquartersBoundedContextModule : NinjectModule
    {
        ...
        public override void Load()
        {
            ...
            CommandRegistry
                ...
                .Handles<AnswerAudioQuestionCommand>(command => command.InterviewId, (command, aggregate) => aggregate.AnswerAudioQuestion(command.UserId, command.QuestionId, command.RosterVector, command.AnswerTime, command.PictureFileName))
