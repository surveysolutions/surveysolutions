    ...
    public class HeadquartersBoundedContextModule : IModule
    {
        ...
        public Task Init(IServiceLocator serviceLocator, UnderConstructionInfo status)
        {
            ...
            CommandRegistry
                ...
                .Handles<MarkInterviewAsReceivedByInterviewer>(command => command.InterviewId, (command, aggregate) => aggregate.MarkInterviewAsReceivedByInterviewer(command.UserId, command.OriginDate))
                .Handles<MarkInterviewAsReceivedBySupervisor>(command => command.InterviewId, (command, aggregate) => aggregate.MarkInterviewAsReceivedBySupervisor(command.UserId, command.OriginDate))
            ...
            CommandRegistry.Configure<StatefulInterview, InterviewCommand>(configuration => 
                ...
                .PostProcessBy<InterviewSummaryErrorsCountPostProcessor>()
                    ...
                    .SkipPostProcessFor<MarkInterviewAsReceivedBySupervisor>()
                ...
                .ValidatedBy<InterviewReceivedByInterviewerCommandValidator>()
                    ...
                    .SkipValidationFor<MarkInterviewAsReceivedBySupervisor>()
