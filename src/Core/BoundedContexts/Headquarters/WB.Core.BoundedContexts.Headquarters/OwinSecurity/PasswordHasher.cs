...
namespace WB.Core.BoundedContexts.Headquarters.OwinSecurity
{
    ...
    public class HqPasswordHasher : IIdentityPasswordHasher
    {
        /* =======================
        ...
        /// <summary>
        /// Creates a new instance of <see cref="HqPasswordHasher"/>.
        /// </summary>
        /// <param name="optionsAccessor">The options for this instance.</param>
        public HqPasswordHasher(IOptions<PasswordHasherOptions> optionsAccessor = null)
        {
