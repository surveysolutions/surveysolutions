...
namespace WB.Core.BoundedContexts.Headquarters.Views.User
{
    ...
    {
        UserListView GetUsersByRole(int pageIndex, int pageSize, string orderBy, string searchBy, bool? archived, UserRoles role, string? workspace = null, bool acrossAllWorkspaces = false, IEnumerable<string>? allowedWorkspaces = null);
