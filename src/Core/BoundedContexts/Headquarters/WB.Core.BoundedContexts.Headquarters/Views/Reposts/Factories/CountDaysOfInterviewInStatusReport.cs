...
namespace WB.Core.BoundedContexts.Headquarters.Views.Reports.Factories
{
    public class CountDaysOfInterviewInStatusReport : ICountDaysOfInterviewInStatusReport
    {
        ...
        public async Task<CountDaysOfInterviewInStatusView> LoadAsync(CountDaysOfInterviewInStatusInputModel input)
        {
            ...
            return new CountDaysOfInterviewInStatusView
            {
                Items = data.ToArray(),
                TotalCount = data.Count,
                TotalRow = new CountDaysOfInterviewInStatusRow()
                {
