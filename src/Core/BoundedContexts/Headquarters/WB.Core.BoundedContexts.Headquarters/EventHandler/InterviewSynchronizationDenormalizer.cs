...
namespace WB.Core.BoundedContexts.Headquarters.EventHandler
{
        ...
        IEventHandler<InterviewHardDeleted>
    {
        ...
        public void Handle(IPublishedEvent<InterviewerAssigned> evnt)
        {
            ...
            var interviewResponsibleInfo = this.interviewResponsibleStorageWriter.GetById(evnt.EventSourceId);
            ...
            this.interviewResponsibleStorageWriter.Store(interviewResponsibleInfo, evnt.EventSourceId);
        }
