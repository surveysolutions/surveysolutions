...
{
    public class MultimediaQuestionViewModel : MvxNotifyPropertyChanged, IInterviewItemViewModel
    {
        ...
        public void Init(string interviewId, Identity questionIdentity)
        {
            ...
            //var questionModel = (MultimediaQuestionModel)questionnaire.Questions[this.identity.Id];
            var answerModel = interview.GetMultimediaAnswerModel(this.identity);
