...
{
    public class LinkedSingleOptionQuestionViewModel : MvxNotifyPropertyChanged, IInterviewItemViewModel
    {
        ...
        public LinkedSingleOptionQuestionViewModel(
        ...
        public void Init(string interviewId, Identity questionIdentity)
        {
            ...
            var questionModel = (LinkedSingleOptionQuestionModel)questionnaire.Questions[this.identity.Id];
            var answerModel = interview.GetLinkedSingleOptionAnswerModel(this.identity);
