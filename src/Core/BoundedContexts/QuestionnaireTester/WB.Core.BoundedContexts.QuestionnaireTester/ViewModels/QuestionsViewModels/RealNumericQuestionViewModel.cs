...
{
    public class RealNumericQuestionViewModel : MvxNotifyPropertyChanged, IInterviewItemViewModel
    {
        ...
        public RealNumericQuestionViewModel(
        ...
        public void Init(string interviewId, Identity questionIdentity)
        {
            ...
            //var questionModel = (RealNumericQuestionModel)questionnaire.Questions[this.identity.Id];
            var answerModel = interview.GetRealNumericAnswerModel(this.identity);
