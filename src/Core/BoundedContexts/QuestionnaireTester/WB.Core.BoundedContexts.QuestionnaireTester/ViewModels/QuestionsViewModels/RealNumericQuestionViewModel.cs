...
{
    public class RealNumericQuestionViewModel : BaseInterviewItemViewModel
    {
        ...
        public RealNumericQuestionViewModel(ICommandService commandService, IPrincipal principal)
        {
        ...
        public override void Init(Identity identity, InterviewModel interviewModel, QuestionnaireModel questionnaireModel)
        {
            ...
            var questionModel = (RealNumericQuestionModel)this.questionnaireModel.Questions[this.identity.Id];
            var answerModel = this.interviewModel.GetRealNumericAnswerModel(this.identity);
