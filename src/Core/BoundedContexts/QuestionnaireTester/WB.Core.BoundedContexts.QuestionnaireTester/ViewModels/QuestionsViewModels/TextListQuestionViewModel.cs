...
{
    public class TextListQuestionViewModel : MvxNotifyPropertyChanged, IInterviewItemViewModel
    {
       private readonly ICommandService commandService;
        ...
        public void Init(string interviewId, Identity questionIdentity)
        {
            ...
            //var questionModel = (TextListQuestionModel)questionnaire.Questions[this.identity.Id];
            var answerModel = interview.GetTextListAnswerModel(this.identity);
