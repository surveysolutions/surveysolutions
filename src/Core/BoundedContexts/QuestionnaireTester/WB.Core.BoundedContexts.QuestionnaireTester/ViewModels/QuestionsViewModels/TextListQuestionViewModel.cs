...
{
    public class TextListQuestionViewModel : BaseInterviewItemViewModel
    {
        ...
        public TextListQuestionViewModel(ICommandService commandService, IPrincipal principal)
        {
        ...
        public override void Init(Identity identity, InterviewModel interviewModel, QuestionnaireModel questionnaireModel)
        {
            ...
            var questionModel = (TextListQuestionModel)this.questionnaireModel.Questions[this.identity.Id];
            var answerModel = this.interviewModel.GetTextListAnswerModel(this.identity);
        ...
        public Tuple<decimal, string>[] Answer
        {
            get { return answer; }
