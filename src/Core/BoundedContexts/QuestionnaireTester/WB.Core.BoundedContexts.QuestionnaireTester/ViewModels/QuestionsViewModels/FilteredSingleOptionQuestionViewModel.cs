...
{
    public class FilteredSingleOptionQuestionViewModelpublic : BaseInterviewItemViewModel
    {
        ...
        public FilteredSingleOptionQuestionViewModelpublic(ICommandService commandService, IPrincipal principal)
        {
