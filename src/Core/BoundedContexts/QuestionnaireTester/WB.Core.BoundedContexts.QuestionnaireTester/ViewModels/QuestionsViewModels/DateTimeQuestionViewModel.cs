...
{
    public class DateTimeQuestionViewModel : MvxNotifyPropertyChanged, IInterviewItemViewModel
    {
        ...
        public void Init(string interviewId, Identity questionIdentity)
        {
            ...
            DateTimeQuestionModel questionModel = (DateTimeQuestionModel)questionnaire.Questions[this.identity.Id];
            DateTimeAnswerModel answerModel = interview.GetDateTimeAnswerModel(this.identity);
