...
{
    public class SingleOptionQuestionViewModel : BaseInterviewItemViewModel
    {
        ...
        public SingleOptionQuestionViewModel(ICommandService commandService, IPrincipal principal)
        {
        ...
        public override void Init(Identity identity, InterviewModel interviewModel, QuestionnaireModel questionnaireModel)
        {
            ...
            var questionModel = (SingleOptionQuestionModel)this.questionnaireModel.Questions[this.identity.Id];
            var answerModel = this.interviewModel.GetSingleAnswerModel(this.identity);
