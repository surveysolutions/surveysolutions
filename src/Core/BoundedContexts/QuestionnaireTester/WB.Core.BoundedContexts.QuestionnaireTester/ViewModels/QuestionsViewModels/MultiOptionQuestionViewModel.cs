...
{
    public class MultiOptionQuestionViewModel : MvxNotifyPropertyChanged, IInterviewItemViewModel
    {
        ...
        public void Init(string interviewId, Identity questionIdentity)
        {
            ...
            var questionModel = (MultiOptionQuestionModel)questionnaire.Questions[this.identity.Id];
            var answerModel = interview.GetMultiOptionAnswerModel(this.identity);
