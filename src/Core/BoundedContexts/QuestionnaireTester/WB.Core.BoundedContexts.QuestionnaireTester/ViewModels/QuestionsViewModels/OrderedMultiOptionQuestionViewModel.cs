...
{
    public class OrderedMultiOptionQuestionViewModel : BaseInterviewItemViewModel
    {
        ...
        public OrderedMultiOptionQuestionViewModel(ICommandService commandService, IPrincipal principal)
        {
