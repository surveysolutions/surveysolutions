...
{
    public class LinkedMultiOptionQuestionViewModel: BaseInterviewItemViewModel
    {
        ...
        public LinkedMultiOptionQuestionViewModel(ICommandService commandService, IPrincipal principal)
        {
        ...
        public override void Init(Identity identity, InterviewModel interviewModel, QuestionnaireModel questionnaireModel)
        {
            ...
            var questionModel = (LinkedMultiOptionQuestionModel)this.questionnaireModel.Questions[this.identity.Id];
            var answerModel = this.interviewModel.GetLinkedMultiOptionAnswerModel(this.identity);
