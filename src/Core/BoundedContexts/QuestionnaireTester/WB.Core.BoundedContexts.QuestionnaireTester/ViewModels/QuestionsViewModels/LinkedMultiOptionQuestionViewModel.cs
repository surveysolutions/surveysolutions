...
{
    public class LinkedMultiOptionQuestionViewModel : MvxNotifyPropertyChanged, IInterviewItemViewModel
    {
        ...
        public LinkedMultiOptionQuestionViewModel(
        ...
        public void Init(string interviewId, Identity questionIdentity)
        {
            ...
            //var questionModel = (LinkedMultiOptionQuestionModel)questionnaire.Questions[this.identity.Id];
            var answerModel = interview.GetLinkedMultiOptionAnswerModel(this.identity);
