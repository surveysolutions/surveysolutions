...
{
    public class CascadingSingleOptionQuestionViewModel : MvxNotifyPropertyChanged, IInterviewItemViewModel
    {
        ...
        public void Init(string interviewId, Identity questionIdentity)
        {
            ...
            SingleOptionQuestionModel questionModel = (SingleOptionQuestionModel)questionnaire.Questions[this.identity.Id];
            SingleOptionAnswerModel answerModel = interview.GetSingleAnswerModel(this.identity);
