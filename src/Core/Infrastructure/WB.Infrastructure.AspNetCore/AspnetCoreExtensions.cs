    ...
    public static class AspnetCoreExtensions
    {
            ...
            HostBuilderContext host, string projectName)
        {
            ...
            return logger
                ...
                .Enrich.WithProperty("Version", fvi.FileVersion ?? string.Empty)
                .Enrich.WithProperty("VersionInfo", fvi.ProductVersion ?? string.Empty)
                ...
                hostBuilder
                    .ConfigureWebHostDefaults(webBuilder =>
                    {
                        ...
                        if (args.Contains("--httpsys") && OperatingSystem.IsWindows())
                        {
                            ...
                            throw new Exception("HttpSys is not supported. Use --kestrel");
                        }
