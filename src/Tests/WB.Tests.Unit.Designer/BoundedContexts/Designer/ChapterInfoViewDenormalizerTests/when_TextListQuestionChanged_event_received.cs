...
{
    internal class when_TextListQuestionChanged_event_received : ChaptersInfoViewDenormalizerTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            viewState =
                denormalizer.Update(viewState,
                    Create.Event.TextListQuestionChangedEvent(questionId: questionId, questionVariable: questionVariable,
