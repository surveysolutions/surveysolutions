...
{
    internal class when_NumericQuestionCloned_event_received : ChaptersInfoViewDenormalizerTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            viewState =
                denormalizer.Update(viewState, Create.Event.NumericQuestionClonedEvent(questionId: questionId, parentGroupId: chapterId,
        ...
        It should_groupInfoView_first_chapter_first_question_type_be_equal_to_questionType = () =>
            ((QuestionInfoView)((GroupInfoView)viewState.Items[0]).Items[0]).Type.ShouldEqual(QuestionType.Numeric);
