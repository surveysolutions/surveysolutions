...
{
    internal class when_QuestionnaireCloned_event_received : ChaptersInfoViewDenormalizerTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            viewState =
                denormalizer.Update(null, Create.Event.QuestionnaireClonedEvent(questionnaireId: questionnaireId,
