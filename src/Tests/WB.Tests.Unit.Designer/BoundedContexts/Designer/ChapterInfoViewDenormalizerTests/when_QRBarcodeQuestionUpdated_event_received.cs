...
{
    internal class when_QRBarcodeQuestionUpdated_event_received : ChaptersInfoViewDenormalizerTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            viewState =
                denormalizer.Update(viewState,
                    Create.Event.QRBarcodeQuestionUpdatedEvent(questionId: questionId, questionVariable: questionVariable,
