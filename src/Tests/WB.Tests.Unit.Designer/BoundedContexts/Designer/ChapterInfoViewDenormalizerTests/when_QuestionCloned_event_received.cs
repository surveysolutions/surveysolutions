...
{
    internal class when_QuestionCloned_event_received : ChaptersInfoViewDenormalizerTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            viewState =
                denormalizer.Update(viewState,
                    Create.Event.QuestionClonedEvent(questionId: questionId, parentGroupId: chapterId,
