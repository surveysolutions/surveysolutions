...
namespace WB.Tests.Unit.Designer.BoundedContexts.Designer
{
    ...
    public class QuestionnaireHistoryPostProcessorTests
    {
        ...
        //    usersStorage.Store(new DesignerIdentityUser { Id = responsibleId, UserName = responsibleUserName }, responsibleId.FormatGuid());
        ...
        //    var usersStorage = new TestPlainStorage<DesignerIdentityUser>();
        //    usersStorage.Store(new DesignerIdentityUser { Id = responsibleId, UserName = responsibleName }, responsibleId.FormatGuid());
        //    Setup.InstanceToMockedServiceLocator<IPlainStorageAccessor<DesignerIdentityUser>>(usersStorage);
        ...
        //    var usersStorage = new TestPlainStorage<DesignerIdentityUser>();
        //    usersStorage.Store(new DesignerIdentityUser { Id = responsibleId, UserName = responsibleUserName, Email = responsibleUserName + "email" }, responsibleId.FormatGuid());
        //    usersStorage.Store(new DesignerIdentityUser { Id = sharedWithId, UserName = sharedWithUserName, Email = sharedWithUserName + "email" }, sharedWithId.FormatGuid());
