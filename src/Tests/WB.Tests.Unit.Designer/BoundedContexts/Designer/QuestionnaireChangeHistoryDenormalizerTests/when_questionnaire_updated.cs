...
namespace WB.Tests.Unit.Designer.BoundedContexts.Designer.QuestionnaireChangeHistoryDenormalizerTests
{
    internal class when_questionnaire_updated : QuestionnaireChangeHistoryDenormalizerTestContext
    {
        ...
        Because of = () =>
            questionnaireChangeHistoryDenormalizer.Handle(Create.Event.QuestionnaireUpdatedEvent(questionnaireId: questionnaireId,questionnaireTitle: questionnaireTitle));
