...
{
    internal class when_replacing_texts_in_filter_expression : QuestionnaireTestsContext
    {
        Establish context = () =>
        {
        ...
        It should_replace_text_in_filter_expression = () =>
                questionnaire.QuestionnaireDocument.Find<IQuestion>(filteredQuestionId).Properties.OptionsFilterExpression.ShouldEqual($"filter with {replaceWith}");
