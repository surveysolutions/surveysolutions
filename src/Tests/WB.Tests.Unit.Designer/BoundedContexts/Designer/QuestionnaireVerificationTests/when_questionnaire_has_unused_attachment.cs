...
{
    internal class when_questionnaire_has_unused_attachment : QuestionnaireVerifierTestsContext
    {
        Establish context = () =>
        {
            ...
            {
                Create.AttachmentView(id: attachment1Id, size: 26 * 1024)
            };
        ...
        It should_return_WB0215_warning = () =>
            errors.ShouldContainWarning("WB0215");
