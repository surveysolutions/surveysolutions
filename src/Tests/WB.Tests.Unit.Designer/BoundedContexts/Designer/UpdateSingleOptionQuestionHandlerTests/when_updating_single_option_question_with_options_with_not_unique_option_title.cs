...
{
    internal class when_updating_single_option_question_with_options_with_not_unique_option_title : QuestionnaireTestsContext
    {
        ...
        [NUnit.Framework.Test] public void should_throw_exception_with_message_containting__answer_title_arent_unique__ () =>
            new[] { "answer title is not unique" }.ShouldEachConformTo(
        ...
        private static Option[] options = new Option[] { new Option(Guid.NewGuid(), "1", "Option 1"), new Option(Guid.NewGuid(), "2", "Option 1"), };
