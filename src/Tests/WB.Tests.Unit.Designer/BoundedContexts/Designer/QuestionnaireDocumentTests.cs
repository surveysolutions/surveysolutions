...
namespace WB.Tests.Unit.Designer.BoundedContexts.Designer
{
    ...
    internal class QuestionnaireDocumentTests
    {
        ...
        public void RemoveHeadPropertiesFromRosters_when_removeRosterTitle_is_called_then_allrosters_titleQuestionId_is_CleanedUp()
        {
            ...
            var doc = this.CreateQuestionnaireDocumentWithTreeRostersOneGroupAndTwoRosterTitleQuestion(questionId, question1Id, roster1Id, roster2Id, roster3Id, group1Id);
