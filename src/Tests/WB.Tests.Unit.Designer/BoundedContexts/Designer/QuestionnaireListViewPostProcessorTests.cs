...
namespace WB.Tests.Unit.Designer.BoundedContexts.Designer
{
    ...
    public class QuestionnaireListViewPostProcessorTests
    {
        ...
        public void When_CloneQuestionnaire_command()
        {
            ...
            var accountStorage = new TestPlainStorage<Account>();
            accountStorage.Store(new Account {UserName = userName}, clonnerId.FormatGuid());
            Setup.InstanceToMockedServiceLocator<IPlainStorageAccessor<Account>>(accountStorage);
        ...
        public void When_AddSharedPerson_command()
        {
            ...
            var questionnaireOwner = new Account { UserName = "questionnaire owner name", Email = "questionnaire owner email" };
