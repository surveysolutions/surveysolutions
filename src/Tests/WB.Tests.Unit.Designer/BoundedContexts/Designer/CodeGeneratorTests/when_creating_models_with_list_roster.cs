...
{
    internal class when_creating_models_with_list_roster : CodeGeneratorTestsContext
    {
        Establish context = () =>
        {
        ...
        It should_create_fixed_roster_model = () =>
        {
            ...
            roster.VariableName.ShouldEqual("list_roster");
            roster.RosterScopeName.ShouldEqual("@__list_roster_scope");
            roster.TypeName.ShouldStartWith("@__list_roster_aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa_");
