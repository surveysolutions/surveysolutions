...
namespace WB.Tests.Unit.Designer.BoundedContexts.Designer.CodeGeneratorTests
{
    internal class when_creating_models_with_list_roster : CodeGeneratorTestsContext
    {
        ...
        [NUnit.Framework.Test] public void should_create_fixed_roster_model () 
        {
            ...
            roster.VariableName.Should().Be("list_roster");
            roster.RosterScopeName.Should().Be("@__list_roster_scope");
            roster.TypeName.Should().StartWith("@__list_roster_aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa_");
