...
{
    internal class when_GroupCloned_event_received_and_new_group_inside_chapter : QuestionnaireInfoViewDenormalizerTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            viewState =
                denormalizer.Update(viewState, Create.Event.GroupClonedEvent(groupId: groupId, parentGroupId: chapterId));
