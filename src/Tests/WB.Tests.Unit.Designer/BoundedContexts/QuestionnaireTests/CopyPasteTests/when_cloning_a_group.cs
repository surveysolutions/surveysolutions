...
namespace WB.Tests.Unit.Designer.BoundedContexts.QuestionnaireTests.CopyPasteTests
{
    ...
    internal class when_cloning_a_fixed_roster
    {
        ...
        Because of = () => clone.FixedRosterTitles[0].Title = "changed";

        It should_not_change_original_fixed_roster_title_when_chaning_title_in_clone = () => original.FixedRosterTitles[0].Title.ShouldEqual("title1");
