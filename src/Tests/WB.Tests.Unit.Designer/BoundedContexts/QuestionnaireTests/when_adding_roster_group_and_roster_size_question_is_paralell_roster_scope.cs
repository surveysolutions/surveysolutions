...
namespace WB.Tests.Unit.Designer.BoundedContexts.QuestionnaireTests
{
    internal class when_adding_roster_group_and_roster_size_question_is_paralell_roster_scope : QuestionnaireTestsContext
    {
        Establish context = () =>
        {
            ...
            questionnaire.AddQuestion(Create.Event.NumericQuestionAdded(publicKey: rosterSizeQuestionId, groupPublicKey: anotherRosterId, isInteger : true));
        ...
        Because of = () =>
            exception = Catch.Exception(() =>
                questionnaire.AddGroupAndMoveIfNeeded(groupId, responsibleId, "title",null, rosterSizeQuestionId, null, null, false, parallelRosterId, true,
