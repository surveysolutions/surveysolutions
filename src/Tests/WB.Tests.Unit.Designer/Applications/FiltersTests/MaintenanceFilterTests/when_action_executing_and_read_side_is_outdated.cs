...
namespace WB.Tests.Unit.Applications.FiltersTests.MaintenanceFilterTests
{
    internal class when_action_executing_and_read_side_is_outdated : MaintenanceFilterTestsContext
    {
        Establish context = () =>
        {
            ...
            readSideStatusServiceMock.Setup(_ => _.IsReadSideOutdated()).Returns(true);
        ...
        It should_action_executing_result_action_route_value_be_equal_to_ReadSideIsOutdated = () =>
            GetActionExecutingContextResult().RouteValues["action"].ShouldEqual("ReadSideIsOutdated");
