...
namespace WB.Tests.Unit.Designer.Api.Tester.TranslationsControllerTests
{
    public class when_getting_translations : TranslationsControllerTestsContext
    {
        ...
        Because of = () => expectedTranslations = controller.Get(questionnaireId,  version: ApiVersion.CurrentTesterProtocolVersion);

        It should_return_only_1_translation_by_specified_questionnaire = () =>
