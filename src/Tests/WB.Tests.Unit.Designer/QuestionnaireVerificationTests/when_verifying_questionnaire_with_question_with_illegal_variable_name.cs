...
{
    internal class when_verifying_questionnaire_with_question_with_illegal_variable_name : QuestionnaireVerifierTestsContext
    {
        ...
        [NUnit.Framework.Test] public void should_return_message_with_code__WB0058 () =>
            verificationMessages.Single().Code.Should().Be("WB0058");
