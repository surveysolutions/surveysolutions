...
{
    internal class when_verifying_questionnaire_with_long_multi_roster_with_79_rows_and_nested_roster : QuestionnaireVerifierTestsContext
    {
        ...
        [NUnit.Framework.Test] public void should_return_message_with_level_general () =>
            verificationMessages.GetError("WB0080").MessageLevel.Should().Be(VerificationMessageLevel.General);

        [NUnit.Framework.Test] public void should_return_message_with_reference_on_roster () =>
            verificationMessages.GetError("WB0080").References.Single().Id.Should().Be(rosterId);
