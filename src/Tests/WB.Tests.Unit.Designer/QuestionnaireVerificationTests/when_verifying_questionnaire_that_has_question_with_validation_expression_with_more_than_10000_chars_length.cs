...
{
    internal class when_verifying_questionnaire_that_has_question_with_validation_expression_with_more_than_10000_chars_length : QuestionnaireVerifierTestsContext
    {
        ...
        [NUnit.Framework.Test] public void should_return_message_with_code__WB0104 () =>
            verificationMessages.First().Code.Should().Be("WB0104");
        ...
        [NUnit.Framework.Test] public void should_not_call_GenerateProcessorStateAssembly () =>
            questionnireExpressionProcessorGeneratorMock.Verify(x => x.GenerateProcessorStateAssembly(Moq.It.IsAny<QuestionnaireCodeGenerationPackage>(), Moq.It.IsAny<int>(), out generationResult), Times.Never);
