...
{
    internal class when_handshaking_capi_with_supervisor_and_device_is_not_specified : SyncControllerTestContext
    {
        Establish context = () =>
        {
        ...
        It should_call_LinkUserToDevice_method = () =>
           syncManagerMock.Verify(
               x => x.LinkUserToDevice(userId, androidId, "13", null),
               Times.Once);
