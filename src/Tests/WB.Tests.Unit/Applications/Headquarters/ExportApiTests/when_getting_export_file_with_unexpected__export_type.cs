...
{
    public class when_getting_export_file_with_unexpected__export_type : ExportControllerTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () => result = controller.Get(new QuestionnaireIdentity().ToString(), "unexpected export type");
