...
{
    public class when_starting_export_process_with_unexpected_export_type : ExportControllerTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () => result = controller.StartProcess(new QuestionnaireIdentity().ToString(), "unexpected export type");
