...
namespace WB.Tests.Unit.Applications.Designer.PublicServiceTests
{
    internal class when_downloading_questionnaire_and_processor_generator_failed : PublicServiceTestContext
    {
        Establish context = () =>
        {
            ...
            string assembly;
            expressionProcessorGenerator.Setup(x => x.GenerateProcessorStateAssemblyForVersion(Moq.It.IsAny<QuestionnaireDocument>(),Moq.It.IsAny<EngineVersion>(), out assembly))
