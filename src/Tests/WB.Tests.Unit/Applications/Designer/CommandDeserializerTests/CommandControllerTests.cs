...
namespace WB.Tests.Unit.Applications.Designer.CommandDeserializerTests
{
    ...
    public class CommandControllerTests
    {
        ...
        public void Execute_When_CommandService_throws_exception_with_inner_DomainExcetion_Then_()
        {
            ...
            Mock.Get(commandService).Setup(x => x.Execute(updateGroupCommand, It.IsAny<string>())).Throws(this.CreateTwoLevelException());
            ...
            var controller = this.CreateCommandController(commandService: commandService, commandDeserializer: commandDeserializer, responsibleId: responsibleId);
        ...
        public void Execute_When_CommandService_throws_exception_with_inner_not_DomainExcetion_Then_exception_should_be_thrown()
        {
            ...
            var commandService = Mock.Of<ICommandService>();
            Mock.Get(commandService).Setup(x => x.Execute(updateGroupCommand, It.IsAny<string>())).Throws(this.CreateThreeLevelException());
        ...
        {
            return new Exception("message", this.CreateTwoLevelException());
        }
