...
{
    public class when_invoking_ValueChangeCommand_and_there_is_match_in_options_list : CascadingSingleOptionQuestionViewModelTestContext
    {
        Establish context = () =>
        {
        ...
        private static readonly int answerOnChildQuestion = 2;
