...
{
    public class when_the_second_section_was_selected_and_the_same_section_was_previously_selected : SectionsViewModelTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            sectionsModel.Sections[1].NavigateToSectionCommand.Execute(sectionsModel.Sections[1]);
