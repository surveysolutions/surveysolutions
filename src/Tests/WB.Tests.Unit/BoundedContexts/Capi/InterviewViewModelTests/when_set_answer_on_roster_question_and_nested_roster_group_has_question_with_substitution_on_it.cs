...
{
    internal class when_set_answer_on_roster_question_and_nested_roster_group_has_question_with_substitution_on_it : InterviewViewModelTestContext
    {
        Establish context = () =>
        {
            ...
            questionnarie = CreateQuestionnaireDocumentWithOneChapter(
                ...
                new Group()
                {
                    ...
                    Children = new List<IComposite>
                    {
                        ...
                        new TextQuestion(){PublicKey = questionSourceOfSubstitutionId, StataExportCaption = "sub_sorce", QuestionType = QuestionType.Text}
                    }
                });
