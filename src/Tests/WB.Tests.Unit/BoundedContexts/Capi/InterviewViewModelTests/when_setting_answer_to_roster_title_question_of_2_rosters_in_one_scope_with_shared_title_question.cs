...
namespace WB.Tests.Unit.BoundedContexts.Capi.InterviewViewModelTests
{
    internal class when_setting_answer_to_roster_title_question_of_2_rosters_in_one_scope_with_shared_title_question : InterviewViewModelTestContext
    {
        ...
        It should_title_of_first_roster_be_equal_set_title = () =>
            ((QuestionnairePropagatedScreenViewModel)interviewViewModel.Screens[InterviewViewModel.ConvertIdAndRosterVectorToString(rosterGroupId1, new decimal[] { 0 })]).ScreenName.ShouldEqual(rosterTitle);

        It should_title_of_second_roster_be_equal_set_title = () =>
            ((QuestionnairePropagatedScreenViewModel)interviewViewModel.Screens[InterviewViewModel.ConvertIdAndRosterVectorToString(rosterGroupId2, new decimal[] { 0 })]).ScreenName.ShouldEqual(rosterTitle);
