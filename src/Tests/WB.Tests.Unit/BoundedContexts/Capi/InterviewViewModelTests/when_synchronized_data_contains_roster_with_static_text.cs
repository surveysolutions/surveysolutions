...
namespace WB.Tests.Unit.BoundedContexts.Capi.InterviewViewModelTests
{
    internal class when_synchronized_data_contains_roster_with_static_text : InterviewViewModelTestContext
    {
        ...
        {
            return
                ((QuestionnaireGridViewModel)(interviewViewModel.Screens[InterviewViewModel.ConvertInterviewItemId(interviewItemId)])).Rows.ElementAt(indexOfRow).Items[0] as StaticTextViewModel;
        }
