...
namespace WB.Tests.Unit.BoundedContexts.Capi.InterviewViewModelTests
{
    internal class when_nested_roster_screen_is_set_to_disabled : InterviewViewModelTestContext
    {
        ...
        Because of = () =>
            interviewViewModel.SetScreenStatus(InterviewItemId.ConvertIdAndRosterVectorToString(nestedRosterId, new decimal[] { 0, 0 }), false);
        ...
        It should_nested_roster_screen_be_disabled = () =>
          ((QuestionnairePropagatedScreenViewModel)interviewViewModel.Screens[InterviewItemId.ConvertIdAndRosterVectorToString(nestedRosterId, new decimal[] { 0, 0 })]).Enabled.ShouldBeFalse();
