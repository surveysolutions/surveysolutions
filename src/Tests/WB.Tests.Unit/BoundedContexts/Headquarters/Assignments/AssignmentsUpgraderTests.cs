...
namespace WB.Tests.Unit.BoundedContexts.Headquarters.Assignments
{
    ...
    public class AssignmentsUpgraderTests
    {
        ...
        public void should_not_upgrade_archived_assignments()
        {
            ...
            // Act
            service.Upgrade(new QueuedUpgrade(new Guid(), Guid.NewGuid(), migrateFrom, migrateTo));
        ...
        public void should_mark_cancelled_process_as_cancelled()
        {
            ...
            // Act
            service.Upgrade(new QueuedUpgrade(processId, Guid.NewGuid(), migrateFrom, migrateTo), cancellationToken);
