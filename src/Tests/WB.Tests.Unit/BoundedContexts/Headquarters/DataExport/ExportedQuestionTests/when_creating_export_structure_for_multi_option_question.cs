...
namespace WB.Tests.Unit.BoundedContexts.Headquarters.DataExport.ExportedQuestionTests
{
    public class when_creating_export_structure_for_multi_option_question : ExportedQuestionTestContext
    {
        ...
        Because of = () =>
        {
            filledQuestion = CreateFilledExportedQuestion(QuestionType.MultyOption, 3, new object[] {2m, 0m});
        ...
        It should_return_correct_filled_answer = () => filledQuestion.Answers.ShouldEqual(new []{ "1", "0", "1" });
