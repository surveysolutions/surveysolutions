...
namespace WB.Tests.Unit.BoundedContexts.Headquarters.InterviewsFeedDenormalizerTests
{
    ...
    internal class when_interview_hard_deleted_on_hq
    {
        Establish context = () =>
        {
            ...
            denormalizer = Create.Service.InterviewsFeedDenormalizer(writer, interviewSummaryRepository: interviews);
        };
        ...
        private It should_write_new_event_to_feed = () =>
            writer.Received().Store(
                Arg.Is<InterviewFeedEntry>(x =>
                    ...
                    x.EntryType == EntryType.InterviewDeleted &&
        ...
        static IPublishedEvent<InterviewHardDeleted> interviewDeletedEvent;
