...
namespace WB.Tests.Unit.BoundedContexts.Interviewer.Services.InterviewerPlainInterviewFileStorageTests
{
    internal class when_getting_interview_binary_data : InterviewerPlainInterviewFileStorageTestsContext
    {
        ...
        Because of = () =>
            bytesResult = interviewerFileSystemInterviewFileStorage.GetInterviewBinaryData(interviewId, imageFileName);
        ...
        static InterviewerFileSystemInterviewFileStorage interviewerFileSystemInterviewFileStorage;
