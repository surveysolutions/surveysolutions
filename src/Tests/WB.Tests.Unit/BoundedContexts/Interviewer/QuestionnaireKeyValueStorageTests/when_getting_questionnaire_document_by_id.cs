...
namespace WB.Tests.Unit.BoundedContexts.Interviewer.QuestionnaireKeyValueStorageTests
{
    internal class when_getting_questionnaire_document_by_id
    {
        Establish context = () =>
        {
            ...
            questionnaireKeyValueStorage = Create.Other.QuestionnaireKeyValueStorage(mockOfAsyncPlainStorage.Object);
        };
        ...
        private static Mock<IAsyncPlainStorage<QuestionnaireDocumentView>> mockOfAsyncPlainStorage;
    }
}