...
{
    internal class when_updating_filtered_combobox_options_and_1_option_has_14_digits : QuestionnaireTestsContext
    {
        Establish context = () =>
        {
        ...
        private static Option[] options = { new Option(Guid.NewGuid(), "12345678901234", "Option 1"), new Option(Guid.NewGuid(), "2", "Option 2") };
    }
}
