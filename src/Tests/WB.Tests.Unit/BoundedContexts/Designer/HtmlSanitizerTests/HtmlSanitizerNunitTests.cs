...
namespace WB.Tests.Unit.BoundedContexts.Designer.HtmlSanitizerTests
{
    /// <summary>
    ...
    public class HtmlSanitizerTests
    {
        ...
        /// </summary>
        [Test]
        public void XSSLocatorTest1()
        {
            // Arrange
            var sanitizer = new HtmlSanitizer();
            sanitizer.AllowedTags = new[] { "i", "b", "br", "font" };
            sanitizer.AllowedAttributes = new[] {"color" };
            // Act
            string htmlFragment = @"MA<b width=""3""><table><font color=""red"">IN</font></b><img />";
            string actual = sanitizer.Sanitize(htmlFragment);

            // Assert
            string expected = @"MA<b><font color=""red"">IN</font></b>";
