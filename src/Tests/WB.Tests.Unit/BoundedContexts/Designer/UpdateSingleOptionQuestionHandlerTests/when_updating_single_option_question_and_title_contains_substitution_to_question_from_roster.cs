...
namespace WB.Tests.Unit.BoundedContexts.Designer.UpdateSingleOptionQuestionHandlerTests
{
    internal class when_updating_single_option_question_and_title_contains_substitution_to_question_from_roster : QuestionnaireTestsContext
    {
        Establish context = () =>
        {
            ...
            questionnaire.Apply(CreateNumericQuestionAdded(publicKey: questionFromRosterId, groupPublicKey: rosterId, isInteger:true, stataExportCaption:substitutionVariableName));
