...
{
    internal class when_expression_state_executes_linked_question_filters_for_the_second_time : CodeGenerationTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
                ...
                QuestionnaireDocument questionnaireDocument = Create.QuestionnaireDocument(questionnaireId, children: new[]
            {
                ...
                state.DisableLinkedQuestionOptions(new[] {new Identity(questionId, new decimal[] {1})});
                state.EnableLinkedQuestionOptions(new[] { new Identity(questionId, new decimal[] { 2 }), new Identity(questionId, new decimal[] { 3 }) });
        ...
        It should_result_contain_0_disabled_option = () =>
            results.CountOfDisabledOptions.ShouldEqual(0);
