...
{
    internal class when_TextListQuestionAdded_event_received_and_parent_for_question_does_not_exist : ChaptersInfoViewDenormalizerTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            viewState =
                denormalizer.Update(viewState, Create.TextListQuestionAddedEvent(questionId:questionId, parentGroupId: notExistingGroupId));
