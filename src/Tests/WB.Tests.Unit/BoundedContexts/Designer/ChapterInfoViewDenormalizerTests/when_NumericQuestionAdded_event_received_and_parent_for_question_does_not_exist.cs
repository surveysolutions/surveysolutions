...
{
    internal class when_NumericQuestionAdded_event_received_and_parent_for_question_does_not_exist : ChaptersInfoViewDenormalizerTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            viewState =
                denormalizer.Update(viewState, Create.NumericQuestionAddedEvent(questionId: questionId, parentGroupId: notExistingGroupId));
