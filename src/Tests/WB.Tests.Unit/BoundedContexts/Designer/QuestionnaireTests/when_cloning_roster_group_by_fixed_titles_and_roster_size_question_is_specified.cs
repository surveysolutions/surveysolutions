...
{
    internal class when_cloning_roster_group_by_fixed_titles_and_roster_size_question_is_specified : QuestionnaireTestsContext
    {
        Establish context = () =>
        {
            ...
            rosterFixedTitles = new Tuple<decimal, string>[] { new Tuple<decimal, string>(1,"fixed title 1"), new Tuple<decimal, string>(2,"fixed title 2"), new Tuple<decimal, string>(3,"fixed title 3") };
            ...
            exception = Catch.Exception(
                () =>
                    questionnaire.CloneGroupWithoutChildren(groupId: newGroupId, responsibleId: responsibleId, title: "title", variableName: null,
                        ...
                        targetIndex: 0, sourceGroupId: groupId, parentGroupId: parentGroupId));
