...
{
    internal class when_cloning_chapter_with_multioptions_question : QuestionnaireTestsContext
    {
        Establish context = () =>
        {
        ...
        It should_QuestionCloned_event_AreAnswersOrdered_be_equal_areAnswersOrdered = () =>
            eventContext.GetSingleEvent<QuestionCloned>().AreAnswersOrdered.ShouldEqual(areAnswersOrdered);

        It should_QuestionCloned_event_MaxAllowedAnswers_be_equal_maxAllowedAnswers = () =>
            eventContext.GetSingleEvent<QuestionCloned>().MaxAllowedAnswers.ShouldEqual(maxAllowedAnswers);
        ...
        private static QuestionType questionType = QuestionType.MultyOption;
