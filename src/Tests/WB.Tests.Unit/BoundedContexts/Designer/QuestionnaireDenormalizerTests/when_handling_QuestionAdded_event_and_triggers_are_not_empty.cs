...
{
    internal class when_handling_QuestionAdded_event_and_triggers_are_not_empty : QuestionnaireDenormalizerTestsContext
    {
        Establish context = () =>
        {
            ...
            @event = CreateNewQuestionAddedEvent(questionId: questionId, groupId: parentGroupId, triggers: new List<Guid> { rosterGroupId });
        ...
        private static IPublishedEvent<NewQuestionAdded> @event;
