...
{
    internal class when_verifying_questionnaire_with_question_inside_roster_that_has_condition_references_with_deeper_roster_level : QuestionnaireVerifierTestsContext
    {
        Establish context = () =>
        {
        ...
        It should_return_error_with_code__WB0006 = () =>
            resultErrors.Single().Code.ShouldEqual("WB0006");
