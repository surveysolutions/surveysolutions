    ...
    internal class when_verifying_questionnaire_with_question_that_has_validation_expression_referencing_to_categorical_multi_linked_question : QuestionnaireVerifierTestsContext
    {
        Establish context = () =>
        {
            ...
            questionnaire = Create.QuestionnaireDocument(id: Id.g1, children: Create.Group(groupId: Id.g2, children: new List<IComposite>
            {
                ...
                Create.MultyOptionsQuestion(id: categoricalQuestionId, variable: variableOfLinkedQuestion, linkedToQuestionId: LinkedSourceQuestionId),
            ...
            var expressionProcessor = Mock.Of<IExpressionProcessor>(processor
                => processor.GetIdentifiersUsedInExpression(validationWithLinkedQuestion) == new[] { categoricalQuestionId.ToString() });
