...
{
    internal class when_pulling_new_interview_created_but_interview_but_insterviewer_is_absent_for_now : InterviewsSynchronizerTestsContext
    {
        private Establish context = () =>
        {
            ...
            iInterviewSynchronizationDto = new InterviewSynchronizationDto(interviewId, InterviewStatus.SupervisorAssigned, "", null, null,
