    ...
    public class when_recent_feed_contains_one_new_event
    {
        private Establish context = () =>
        {
            ...
            handler.Protected()
                ...
                {
                    Content = new StringContent(ResourceHelper.ReadResourceFile("WB.Tests.Unit.BoundedContexts.Supervisor.Synchronization.UserChangedFeedReaderTests.Simplefeed.xml"))
                }));
