...
namespace WB.Tests.Unit.BoundedContexts.Supervisor.Synchronization.SynchronizerTests
{
    internal class when_pushing_interviews_to_headquarters : SynchronizerTestsContext
    {
        Establish context = () =>
        {
            synchronizer = Create.Service.Synchronizer(interviewsSynchronizerMock.Object);
        };
