...
{
    internal class when_finding_referenced_answers_for_linked_question_on_roster_level_3_and_referenced_answers_are_on_roster_level_3 : StatefulInterviewTestsContext
    {
        Establish context = () =>
        {
