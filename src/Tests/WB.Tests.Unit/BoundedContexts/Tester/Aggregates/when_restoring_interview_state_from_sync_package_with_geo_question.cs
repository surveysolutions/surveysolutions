...
{
    internal class when_restoring_interview_state_from_sync_package_with_geo_question : StatefulInterviewTestsContext
    {
        Establish context = () =>
        {
            Setup.QuestionnaireWithRepositoryToMockedServiceLocator(questionnaireId, _
                => _.GetQuestionType(questionId) == QuestionType.GpsCoordinates
                   && _.IsQuestionLinked(questionId) == false
