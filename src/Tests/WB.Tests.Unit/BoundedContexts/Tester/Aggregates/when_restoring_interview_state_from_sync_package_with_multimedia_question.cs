...
{
    internal class when_restoring_interview_state_from_sync_package_with_multimedia_question : StatefulInterviewTestsContext
    {
        Establish context = () =>
        {
