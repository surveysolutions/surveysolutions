...
{
    internal class when_finding_referenced_answers_for_linked_question_on_roster_level_3_and_referenced_answers_are_on_roster_level_1 : StatefulInterviewTestsContext
    {
        Establish context = () =>
        {
            linkedQuestionRosterVector = new[] { 1m, 1m, 1m };
            var linkedQuestionRosters = new[] { referencedRoster1, referencedRoster2, referencedRoster3 };
