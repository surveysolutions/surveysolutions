...
namespace WB.Tests.Unit.BoundedContexts.Tester.ViewModels.DashboardViewModelTests
{
    public class when_load_questionnaire_and_server_not_responding : DashboardViewModelTestContext
    {
        ...
        It should_not_be_questionnaire_stored_to_local_storage = () => mockOfQuestionnaireImportService.Verify(_ => _.ImportQuestionnaire(Moq.It.IsAny<QuestionnaireDocument>(), Moq.It.IsAny<string>(), 1), Times.Never);
