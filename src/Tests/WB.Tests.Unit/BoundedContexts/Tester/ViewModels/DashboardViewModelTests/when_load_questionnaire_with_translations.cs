    ...
    internal class when_load_questionnaire_with_translations : DashboardViewModelTestContext
    {
        Establish context = () =>
        {
            downloadedQuestionnaire = new Questionnaire
            {
                ...
                {
                    Create.Entity.Translation(translationId: translationId,  translationName: "ru")
                }),
                Assembly = "assembly"
            };
            ...
            mockOfDesignerApiService
                ...
                {
                    Create.Entity.TranslationDto(translationId: translationId, value: "перевод на русский"),
                    Create.Entity.TranslationDto(translationId: translationId, value: "перевод на русский 2")
        ...
        private static readonly Guid translationId = Guid.Parse("22222222222222222222222222222222");
