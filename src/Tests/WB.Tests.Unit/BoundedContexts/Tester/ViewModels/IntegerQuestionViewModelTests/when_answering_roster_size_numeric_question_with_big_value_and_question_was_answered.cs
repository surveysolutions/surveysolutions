...
{
    public class when_answering_roster_size_numeric_question_with_big_value_and_question_was_answered : IntegerQuestionViewModelTestContext
    {
        Establish context = () =>
        {
            SetUp();
        ...
        It should_mark_question_as_invalid_with_message = () =>
            ValidityModelMock.Verify(x => x.MarkAnswerAsInvalidWithMessage("Answer '50' is incorrect because answer is greater than Roster upper bound '14'."), Times.Once);
