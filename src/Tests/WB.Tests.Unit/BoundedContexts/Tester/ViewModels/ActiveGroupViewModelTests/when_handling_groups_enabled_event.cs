...
namespace WB.Tests.Unit.BoundedContexts.Tester.ViewModels.ActiveGroupViewModelTests
{
    public class when_handling_groups_enabled_event : ActiveGroupViewModelTestContext
    {
        ...
        Because of = () =>
            activeGroup.Handle(Create.Event.GroupsDisabled(enabledGroupIdentity.Id, enabledGroupIdentity.RosterVector));
        ...
        protected static Identity enabledGroupIdentity = Create.Identity(Guid.Parse("33333333333333333333333333333333"), new decimal[] { 1, 2 });
