...
{
    internal class when_handling_groups_enabled_event_and_disabled_group_is_not_on_screen : ActiveGroupViewModelTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            activeGroup.Handle(Create.Event.GroupsEnabled(disabledGroupIdentity.Id, disabledGroupIdentity.RosterVector));
