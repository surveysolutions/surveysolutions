...
{
    internal class when_handling_questions_disabled_event_and_disabled_group_is_not_on_screen : ActiveGroupViewModelTestContext
    {
        Establish context = () =>
        {
        ...
        protected static Identity disabledQuestionIdentity = Create.Identity(Guid.Parse("55555555555555555555555555555555"), new decimal[] { 1 });
