...
namespace WB.Tests.Unit.SharedKernels.Enumerator.StatefulInterviewTests
{
    internal class when_looking_for_options_of_linked_question_which_linked_on_nested_roster_question : StatefulInterviewTestsContext
    {
        Establish context = () =>
        {
            ...
            interview.Apply(Create.Event.TextQuestionAnswered(linkSourceId, Create.RosterVector(1,1), "a"));
            interview.Apply(Create.Event.TextQuestionAnswered(linkSourceId, Create.RosterVector(1,2), "b"));
            interview.Apply(Create.Event.TextQuestionAnswered(linkSourceId, Create.RosterVector(2, 1), "a"));
            interview.Apply(Create.Event.TextQuestionAnswered(linkSourceId, Create.RosterVector(2, 2), "b"));
