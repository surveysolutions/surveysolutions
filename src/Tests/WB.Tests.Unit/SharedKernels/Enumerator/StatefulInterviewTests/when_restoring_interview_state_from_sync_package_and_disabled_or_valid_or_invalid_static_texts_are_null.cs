...
namespace WB.Tests.Unit.SharedKernels.Enumerator.StatefulInterviewTests
{
    internal class when_restoring_interview_state_from_sync_package_and_disabled_or_valid_or_invalid_static_texts_are_null : StatefulInterviewTestsContext
    {
        Establish context = () =>
        {
            interview = Create.AggregateRoot.StatefulInterview(questionnaireId: questionnaireId, questionnaireRepository: Create.Other.QuestionnaireRepositoryStubWithOneQuestionnaire(questionnaireId));
