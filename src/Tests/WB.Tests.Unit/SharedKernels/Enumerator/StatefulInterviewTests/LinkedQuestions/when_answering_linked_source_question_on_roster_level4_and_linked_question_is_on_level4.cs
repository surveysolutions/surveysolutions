            ...
            var questionnaireDocument = Create.Entity.QuestionnaireDocumentWithOneChapter(children: new IComposite[]
            {
                ...
                Create.Entity.ListRoster(roster1Id, rosterSizeQuestionId: rosterSizeQuestion1Id, children: new IComposite[]
                {
                    ...
                    Create.Entity.ListRoster(roster2Id, rosterSizeQuestionId: rosterSizeQuestion2Id, children: new IComposite[]
                    {
                        ...
                        {
                            Create.Entity.TextListQuestion(questionId: rosterSizeQuestion4Id),
                            Create.Entity.ListRoster(roster4Id, rosterSizeQuestionId: rosterSizeQuestion4Id, children: new IComposite[]
                            {
                                Create.Entity.SingleOptionQuestion(questionId: linkedSingleQuestionId, linkedToRosterId: roster4Id),
                                Create.Entity.MultipleOptionsQuestion(questionId: linkedMultiQuestionId, linkedToRosterId: roster4Id),
                            }),
                        }),
                    }),
                }),
