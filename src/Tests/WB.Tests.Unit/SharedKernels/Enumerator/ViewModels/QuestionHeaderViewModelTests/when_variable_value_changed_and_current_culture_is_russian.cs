...
{
    internal class when_variable_value_changed_and_current_culture_is_russian : QuestionHeaderViewModelTestsContext
    {
        ...
        public void BecauseOf() => viewModel.Init("interview", substitutionTargetQuestionIdentity, Create.Other.NavigationState());
