...
namespace WB.Tests.Unit.SharedKernels.Enumerator.ViewModels.StaticTextViewModelTests
{
    internal class when_variable_value_changed_and_current_culture_is_russian : StaticTextViewModelTestsContext
    {
        Establish context = () =>
        {
            ...
            questionnaireRepository.Setup(x => x.GetQuestionnaire(Moq.It.IsAny<QuestionnaireIdentity>(), Moq.It.IsAny<Guid?>())).Returns(questionnaireMock);
        ...
        It should_change_item_title = () => viewModel.Text.PlainText.ShouldEqual("Your first variable is 31.01.2016 and second is 7,77");
