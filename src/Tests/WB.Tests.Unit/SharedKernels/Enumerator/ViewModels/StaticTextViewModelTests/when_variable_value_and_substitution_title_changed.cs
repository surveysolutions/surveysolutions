...
namespace WB.Tests.Unit.SharedKernels.Enumerator.ViewModels.StaticTextViewModelTests
{
    internal class when_variable_value_and_substitution_title_changed : StaticTextViewModelTestsContext
    {
        Establish context = () =>
        {
            ...
            {
                Create.Entity.StaticText(publicKey: staticTextWithSubstitutionId,text: $"Your answer on question is %var1% and variable is %var2%"),
            ...
            statefullInterview.AnswerNumericRealQuestion(interviewerId, substitutedQuestionId, RosterVector.Empty, DateTime.UtcNow, 2);
