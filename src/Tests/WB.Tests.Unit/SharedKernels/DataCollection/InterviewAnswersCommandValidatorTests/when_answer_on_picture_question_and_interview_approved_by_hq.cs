...
{
    internal class when_answer_on_picture_question_and_interview_approved_by_hq : InterviewAnswersCommandValidatorTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () => exception = Catch.Only<InterviewException>(
            () => commandValidator.Validate(interview,
                    Create.AnswerPictureQuestionCommand(interviewId: interviewId, userId: responsibleId)));
