...
{
    internal class when_answer_on_real_question_and_interview_approved_by_hq : InterviewAnswersCommandValidatorTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () => exception = Catch.Only<InterviewException>(
            () => commandValidator.Validate(interview,
                    Create.AnswerNumericRealQuestionCommand(interviewId: interviewId, userId: responsibleId)));
