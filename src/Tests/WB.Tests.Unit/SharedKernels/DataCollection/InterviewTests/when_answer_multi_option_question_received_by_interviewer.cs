    ...
    internal class when_answer_multi_option_question_received_by_interviewer : InterviewTestsContext
    {
        Establish context = () =>
        {
            ...
            var questionnaire = CreateQuestionnaireDocumentWithOneChapter(
                Create.MultipleOptionsQuestion(questionId: questionId));
        ...
        Because of = () =>
            exception = Catch.Only<InterviewException>(() => interview.AnswerMultipleOptionsQuestion(userId, questionId, new decimal[0], DateTime.Now, new decimal[] { 1.1m }));
