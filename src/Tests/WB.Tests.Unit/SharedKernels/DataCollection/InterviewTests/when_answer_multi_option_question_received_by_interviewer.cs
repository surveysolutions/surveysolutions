...
{
    internal class when_answer_multi_option_question_received_by_interviewer : InterviewTestsContext
    {
        [NUnit.Framework.OneTimeSetUp] public void context () {
            ...
            var questionnaire = CreateQuestionnaireDocumentWithOneChapter(
                Create.Entity.MultipleOptionsQuestion(questionId: questionId));
        ...
        public void BecauseOf() =>
            exception =  NUnit.Framework.Assert.Throws<InterviewException>(() => interview.AnswerMultipleOptionsQuestion(userId, questionId, new decimal[0], DateTime.Now, new int[] { }));
