...
{
    internal class when_answer_numeric_integer_question_received_by_interviewer : InterviewTestsContext
    {
        [NUnit.Framework.OneTimeSetUp] public void context () {
            ...
            var questionnaire = CreateQuestionnaireDocumentWithOneChapter(
                Create.Entity.NumericQuestion(questionId: questionId, isInteger: true));
        ...
        public void BecauseOf() =>
            exception =  NUnit.Framework.Assert.Throws<InterviewException>(() => interview.AnswerNumericIntegerQuestion(userId, questionId, new decimal[0], DateTime.Now, 1));
