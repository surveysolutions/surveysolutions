...
namespace WB.Tests.Unit.SharedKernels.DataCollection.InterviewTests.Answers
{
    ...
    internal class when_answering_numeric_question_that_triggers_roster : InterviewTestsContext
    {
        [Test]
        public void should_throw_exception_when_answering_more_than_allowed_value_for_rosters()
        {
