...
{
    internal class when_answer_text_list_question_received_by_interviewer : InterviewTestsContext
    {
        ...
        public void BecauseOf() =>
            exception =  NUnit.Framework.Assert.Throws<InterviewException>(() => interview.AnswerTextListQuestion(userId, questionId, new decimal[0], DateTime.Now, new Tuple<decimal, string>[0]));
