...
namespace WB.Tests.Unit.SharedKernels.DataCollection.InterviewTests
{
    internal class when_answer_on_integer_question_increases_roster_size_of_roster_with_nested_roster_triggered_by_the_same_question : InterviewTestsContext
    {
        ...
        [NUnit.Framework.Test] public void should_raise_RosterInstancesRemoved_event_which_contains_1_last_row_of_parentRoster () =>
        ...
        [NUnit.Framework.Test] public void should_raise_RosterInstancesRemoved_event_which_contains_first_row_of_nestedRoster_in_last_row_of_parentRoster () =>
           eventContext.ShouldContainEvent<RosterInstancesRemoved>(@event
        ...
        [NUnit.Framework.Test] public void should_raise_RosterInstancesRemoved_event_which_contains_second_row_of_nestedRoster_in_last_row_of_parentRoster () =>
           eventContext.ShouldContainEvent<RosterInstancesRemoved>(@event
