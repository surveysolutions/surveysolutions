...
{
    internal class when_answer_multimedia_question_received_by_interviewer : InterviewTestsContext
    {
        ...
        public void BecauseOf() =>
            exception =  NUnit.Framework.Assert.Throws<InterviewException>(() => interview.AnswerPictureQuestion(userId, questionId, new decimal[0], DateTime.Now, "str"));
