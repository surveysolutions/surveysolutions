    ...
    internal class when_answering_yesno_question_which_is_roster_size_question : with_event_context
    {
        Establish context = () =>
        {
            command = Create.Command.AnswerYesNoQuestion(
                answeredOptions: new[]
                {
                    Create.AnsweredYesNoOption(value: option_NotChanged_FromNo______ToNo_____, answer: false),
                    Create.AnsweredYesNoOption(value: option_Deselected_FromNothing_ToNo_____, answer: false),
                    Create.AnsweredYesNoOption(value: option_Deselected_FromYes_____ToNo_____, answer: false),
                    Create.AnsweredYesNoOption(value: option_NotChanged_FromYes_____ToYes____, answer: true),
                    Create.AnsweredYesNoOption(value: option__Selected__FromNothing_ToYes____, answer: true),
                    Create.AnsweredYesNoOption(value: option__Selected__FromNo______ToYes____, answer: true),
                });
            ...
            var questionnaireDocument = Create.QuestionnaireDocument(children: new IComposite[]
            {
                ...
                Create.Roster(rosterId: rosterId, rosterSizeSourceType: RosterSizeSourceType.Question, rosterSizeQuestionId: command.QuestionId),
            });
            ...
            {
                Create.AnsweredYesNoOption(value: option_NotChanged_FromNo______ToNo_____, answer: false),
                Create.AnsweredYesNoOption(value: option__Selected__FromNo______ToYes____, answer: false),
                Create.AnsweredYesNoOption(value: option_Deselected_FromNo______ToNothing, answer: false),
                Create.AnsweredYesNoOption(value: option_NotChanged_FromYes_____ToYes____, answer: true),
                Create.AnsweredYesNoOption(value: option_Deselected_FromYes_____ToNo_____, answer: true),
                Create.AnsweredYesNoOption(value: option_Deselected_FromYes_____ToNothing, answer: true),
            }));
            interview.Apply(Create.Event.RosterInstancesAdded(rosterId: rosterId, fullRosterVectors: new decimal[][]
            {
                Create.RosterVector(option_NotChanged_FromYes_____ToYes____),
                Create.RosterVector(option_Deselected_FromYes_____ToNo_____),
                Create.RosterVector(option_Deselected_FromYes_____ToNothing),
            }));
        };
