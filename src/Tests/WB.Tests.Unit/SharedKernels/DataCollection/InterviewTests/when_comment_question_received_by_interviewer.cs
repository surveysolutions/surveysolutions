...
{
    internal class when_comment_question_received_by_interviewer : InterviewTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            exception = Catch.Only<InterviewException>(() => interview.CommentAnswer(userId, questionId,  new decimal[0], DateTime.UtcNow, "comment"));
