...
namespace WB.Tests.Unit.SharedKernels.DataCollection.InterviewTests
{
    internal class when_answering_timestamp_question_which_is_roster_title : InterviewTestsContext
    {
        Establish context = () =>
        {
            ...
            rosterVector = RosterVector.Empty.Concat(new[] { rosterInstanceId }).ToArray();
            ...
            interview.Apply(Create.Event.RosterInstancesAdded(rosterId, RosterVector.Empty, rosterInstanceId, sortIndex: null));

            eventContext = new EventContext();
        };

        Because of = () =>
            interview.AnswerDateTimeQuestion(userId, timestampQuestionId, rosterVector, DateTime.Now, answerOnDateTimeQuestion);
        ...
        It should_set_answer_on_timestamp_question_in_specified_format_for_RosterInstancesTitleChanged_event = () =>
            eventContext.GetEvent<RosterInstancesTitleChanged>().ChangedInstances[0].Title.ShouldEqual(answerOnDateTimeQuestion.ToLocalTime().ToShortTimeString());
