    ...
    internal class when_answer_gps_coordinate_question_received_by_interviewer : InterviewTestsContext
    {
        Establish context = () =>
        {
            ...
            var questionnaire = CreateQuestionnaireDocumentWithOneChapter(
                Create.Other.GpsCoordinateQuestion(questionId: questionId));
        ...
        Because of = () =>
            exception = Catch.Only<InterviewException>(() => interview.AnswerGeoLocationQuestion(userId, questionId, new decimal[0], DateTime.Now, 1, 1, 1, 1, DateTimeOffset.UtcNow));
