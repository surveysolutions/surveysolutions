...
{
    internal class when_set_flag_question_received_by_interviewer : InterviewTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            exception = Catch.Only<InterviewException>(() => interview.SetFlagToAnswer(userId, questionId,  new decimal[0]));
