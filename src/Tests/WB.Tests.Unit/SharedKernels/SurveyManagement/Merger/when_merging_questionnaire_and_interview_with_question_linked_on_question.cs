    ...
    internal class when_merging_questionnaire_and_interview_with_question_linked_on_question : InterviewDataAndQuestionnaireMergerTestContext
    {
        Establish context = () =>
        {
            ...
            AddInterviewLevel(interview, new ValueVector<Guid> { rosterId }, Create.Entity.RosterVector(1).CoordinatesAsDecimals.ToArray(), 
                ...
                answeredQuestions: new Dictionary<Guid, object>() { { linkedQuestionSourceId, "ros1_txt" } });
            ...
            interview.Levels["#"].QuestionsSearchCache.Add(linkedQuestionId, Create.Entity.InterviewQuestion(linkedQuestionId, new [] {1}));
