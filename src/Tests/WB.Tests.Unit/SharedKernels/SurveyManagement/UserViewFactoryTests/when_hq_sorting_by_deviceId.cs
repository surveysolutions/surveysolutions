...
namespace WB.Tests.Unit.SharedKernels.SurveyManagement.UserViewFactoryTests
{
    internal class when_hq_sorting_by_deviceId : UserViewFactoryTestContext
    {
        Establish context = () =>
        {
            ...
            var interviewer11 = Create.Entity.HqUser(interviewer11Id, supervisor1Id, userName: "interviewer11", deviceId: "device11", interviewerBuild: 101);
            ...
            var interviewer21 = Create.Entity.HqUser(interviewer21Id, supervisor2Id, userName: "interviewer21", deviceId: "device21", interviewerBuild: 101);

            supervisor3 = Create.Entity.HqUser(supervisor3Id, null, userName: "supervisor3", role: UserRoles.Supervisor);
            var interviewer31 = Create.Entity.HqUser(interviewer31Id, supervisor3Id, userName: "interviewer31", isArchived: true, deviceId: "device31", interviewerBuild: 100);
            var interviewer32 = Create.Entity.HqUser(interviewer32Id, supervisor3Id, userName: "interviewer32");
            var interviewer33 = Create.Entity.HqUser(interviewer33Id, supervisor3Id, userName: "interviewer33", deviceId: "device33", interviewerBuild: 101);
        ...
        Because of = () => result = interviewersViewFactory.GetInterviewers(0, 20, "DeviceId", null, false, InterviewerOptionFilter.UpToDate, 101, null);
        ...
        private static readonly Guid headquarter1Id =  Guid.Parse("77777777777777777777777777777777");
        ...
        private static readonly Guid supervisor3Id =   Guid.Parse("33333333333333333333333333333333");
        ...
        private static readonly Guid interviewer31Id = Guid.Parse("03111111111111111111111111111111");
        private static readonly Guid interviewer32Id = Guid.Parse("03222222222222222222222222222222");
        private static readonly Guid interviewer33Id = Guid.Parse("03333333333333333333333333333333");
        private static readonly Guid interviewer34Id = Guid.Parse("03444444444444444444444444444444");
    }
}