...
{
    internal class when_answering_geo_question_that_in_roster_and_collection_has_one_answer : AnswersByVariableDenormalizerTestContext
    {
        Establish context = () =>
        {
        ...
        It should_set_dictionary_with_only_one_row_in_Answers_collection_with_interviewId_key = () =>
            answersCollection.Answers[interviewId].Count.ShouldEqual(2);

        It should_set_dictionary_with_key_equals__sharp__in_Answers_collection_with_interviewId_key = () =>
            answersCollection.Answers[interviewId].Keys.ShouldContainOnly(new[] { "0.5", "1.5" });
