...
{
    internal class when_handling_InterviewFromPreloadedDataCreated_event_and_responsible_user_not_found : InterviewSummaryEventHandlerFunctionalTestsContext
    {
