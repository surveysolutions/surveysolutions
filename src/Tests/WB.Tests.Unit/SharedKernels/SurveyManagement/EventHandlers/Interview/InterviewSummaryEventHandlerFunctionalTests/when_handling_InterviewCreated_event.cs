...
{
    internal class when_handling_InterviewCreated_event : InterviewSummaryEventHandlerFunctionalTestsContext
    {
        ...
        Because of = () =>
            viewModel = denormalizer.Update(null, Create.InterviewCreatedEvent(userId: responsibleId));
