...
{
    internal class when_InterviewerAssigned_recived : InterviewHistoryDenormalizerTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            interviewHistoryView = interviewExportedDataDenormalizer.Update(interviewHistoryView, CreatePublishableEvent(() => new InterviewerAssigned(Guid.NewGuid(), Guid.NewGuid()),
                interviewId));

        It should_action_of_first_record_be_InterviewerAssigned = () =>
