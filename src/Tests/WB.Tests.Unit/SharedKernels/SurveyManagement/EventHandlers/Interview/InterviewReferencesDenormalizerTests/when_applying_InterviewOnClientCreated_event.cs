...
{
    internal class when_applying_InterviewOnClientCreated_event
    {
        Establish context = () =>
        {
            @event = Create.Event
                .InterviewOnClientCreated(questionnaireId: questionnaireId, questionnaireVersion: questionnaireVersion)
