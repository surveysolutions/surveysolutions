...
{
    internal class when_request_report_by_interviewers_for_user_in_hq_role : QuantityControllerTestContext
    {
        Establish context = () =>
        {
        ...
        It should_go_back_to_supervisor_button_be_visible = () =>
            ((bool)result.ViewBag.CanNavigateToQuantityBySupervisors).ShouldEqual(true);
