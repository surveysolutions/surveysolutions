...
{
    internal class when_DeletePreloadedDataOfSample_is_called : FilebasedPreloadedDataRepositoryTestContext
    {
        ...
        Because of = () => filebasedPreloadedDataRepository.DeletePreloadedDataOfSample(csvFileId);
