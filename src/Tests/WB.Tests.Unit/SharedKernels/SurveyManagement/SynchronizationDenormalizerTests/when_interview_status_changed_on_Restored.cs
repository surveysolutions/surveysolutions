...
{
    internal class when_interview_status_changed_on_Restored : InterviewSynchronizationDenormalizerTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            denormalizer.Handle(Create.Event.Published.InterviewStatusChanged(interviewId, InterviewStatus.Restored));
