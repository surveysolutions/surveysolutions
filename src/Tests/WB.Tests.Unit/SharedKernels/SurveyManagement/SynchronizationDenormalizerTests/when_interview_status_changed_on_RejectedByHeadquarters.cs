...
{
    internal class when_interview_status_changed_on_RejectedByHeadquarters : InterviewSynchronizationDenormalizerTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            denormalizer.Handle(Create.Event.Published.InterviewStatusChanged(interviewId, InterviewStatus.RejectedByHeadquarters));
