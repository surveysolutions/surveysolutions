...
{
    internal class when_request_report_by_supervisors : PeriodicStatusReportControllerTestContext
    {
        Establish context = () =>
        {
        ...
        It should_WebApiActionName_be_QuantityBySupervisors = () =>
           ((PeriodicStatusReportModel)result.Model).WebApiActionName.ShouldEqual("BySupervisors");
