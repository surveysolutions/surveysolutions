    ...
    internal class when_verifying_preloaded_data_with_incorrect_type : PreloadedDataVerifierTestContext
    {
        private Establish context = () =>
        {
            ...
            preloadedDataServiceMock.Setup(
                x => x.ParseQuestionInLevel(Moq.It.IsAny<string>(), "q1", Moq.It.IsAny<HeaderStructureForLevel>(), out outValue)).Returns(ValueParsingResult.QuestionTypeIsIncorrect);
        ...
        private It should_return_single_PL0014_error = () =>
            status.VerificationState.Errors.First().Code.ShouldEqual("PL0015");
