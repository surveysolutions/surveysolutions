...
{
    [NUnit.Framework.Ignore("KP-10197. Disabled verification")]
    internal class when_verifying_preloaded_data_with_linked_question : PreloadedDataVerifierTestContext
    {
        [NUnit.Framework.OneTimeSetUp] public void context () {
            ...
            preloadedDataServiceMock.Setup(
                x => x.ParseQuestionInLevel(Moq.It.IsAny<string>(), "q1", Moq.It.IsAny<HeaderStructureForLevel>(), out outValue)).Returns(ValueParsingResult.UnsupportedLinkedQuestion);
        ...
        [NUnit.Framework.Test] public void should_return_single_PL0010_error () =>
            status.VerificationState.Errors.First().Code.Should().Be("PL0010");
