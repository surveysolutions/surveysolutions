    ...
    internal class when_verifying_preloaded_data_with_incorrect_integer_value : PreloadedDataVerifierTestContext
    {
        [NUnit.Framework.OneTimeSetUp] public void context () {
            ...
            preloadedDataServiceMock.Setup(
                x => x.ParseQuestionInLevel(Moq.It.IsAny<string>(), "q1", Moq.It.IsAny<HeaderStructureForLevel>(), out outValue)).Returns(ValueParsingResult.AnswerAsIntWasNotParsed);
        ...
        [NUnit.Framework.Test] public void should_return_single_PL0018_error () =>
            status.VerificationState.Errors.First().Code.Should().Be("PL0018");
