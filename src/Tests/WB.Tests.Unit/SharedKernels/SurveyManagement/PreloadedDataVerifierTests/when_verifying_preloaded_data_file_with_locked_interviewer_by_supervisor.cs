...
namespace WB.Tests.Unit.SharedKernels.SurveyManagement.PreloadedDataVerifierTests
{
    internal class when_verifying_preloaded_data_file_with_locked_interviewer_by_supervisor : PreloadedDataVerifierTestContext
    {
        Establish context = () =>
        {
            ...
            preloadedDataByFile = CreatePreloadedDataByFile(new[] { "Id", "responsible" }, new string[][] { new string[] { "1", "fd" } },
            ...
            userViewFactory.Setup(x => x.Load(Moq.It.IsAny<UserViewInputModel>())).Returns(new UserView(){IsLockedBySupervisor = true});
