    ...
    internal class when_verifying_preloaded_data_and_question_was_not_found : PreloadedDataVerifierTestContext
    {
        [NUnit.Framework.OneTimeSetUp] public void context () {
            ...
            preloadedDataServiceMock.Setup(
                x => x.ParseQuestionInLevel(Moq.It.IsAny<string>(), "q1", Moq.It.IsAny<HeaderStructureForLevel>(), out outValue)).Returns(ValueParsingResult.QuestionWasNotFound);
        ...
        [NUnit.Framework.Test] public void should_return_single_PL0012_error () =>
            status.VerificationState.Errors.First().Code.Should().Be("PL0012");
