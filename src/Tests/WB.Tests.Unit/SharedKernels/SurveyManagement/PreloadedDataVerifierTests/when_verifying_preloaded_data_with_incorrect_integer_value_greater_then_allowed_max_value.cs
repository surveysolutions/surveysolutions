...
{
    internal class when_verifying_preloaded_data_with_incorrect_integer_value_greater_then_allowed_max_value : PreloadedDataVerifierTestContext
    {
        private Establish context = () =>
        {
            ...
            preloadedDataServiceMock.Setup(
                x => x.ParseQuestion(Moq.It.IsAny<string>(), Moq.It.IsAny<IQuestion>(), out outValue)).Returns(ValueParsingResult.AnswerIsIncorrectBecauseIsGreaterThanMaxValue);
        ...
        private It should_return_single_PL0020_error = () =>
            result.Errors.First().Code.ShouldEqual("PL0020");
