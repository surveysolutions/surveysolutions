    ...
    internal class when_verifying_preloaded_data_with_general_error : PreloadedDataVerifierTestContext
    {
        private Establish context = () =>
        {
            ...
            preloadedDataServiceMock.Setup(
                x => x.ParseQuestion(Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), Moq.It.IsAny<IQuestion>(), out outValue)).Returns(ValueParsingResult.GeneralErrorOccured);
        ...
        private It should_return_single_PL0011_error = () =>
            result.Errors.First().Code.ShouldEqual("PL0011");
