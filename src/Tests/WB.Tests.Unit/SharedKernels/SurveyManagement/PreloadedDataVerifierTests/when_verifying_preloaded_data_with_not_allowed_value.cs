    ...
    internal class when_verifying_preloaded_data_with_not_allowed_value : PreloadedDataVerifierTestContext
    {
        private Establish context = () =>
        {
            ...
            preloadedDataServiceMock.Setup(
                x => x.ParseQuestionInLevel(Moq.It.IsAny<string>(), "q1", Moq.It.IsAny<HeaderStructureForLevel>(), out outValue)).Returns(ValueParsingResult.ParsedValueIsNotAllowed);
        ...
        private It should_return_single_PL0014_error = () =>
            VerificationErrors.First().Code.ShouldEqual("PL0014");
