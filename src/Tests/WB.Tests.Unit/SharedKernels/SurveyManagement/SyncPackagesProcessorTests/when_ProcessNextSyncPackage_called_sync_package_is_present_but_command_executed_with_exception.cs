...
{
    internal class when_ProcessNextSyncPackage_called_sync_package_is_present_but_command_executed_with_exception : SyncPackagesProcessorTestContext
    {
        Establish context = () =>
        {
            ...
            commandServiceMock.Setup(x => x.Execute(Moq.It.IsAny<SynchronizeInterviewEventsCommand>(), Moq.It.IsAny<string>(), Moq.It.IsAny<bool>()))
