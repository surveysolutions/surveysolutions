...
{
    internal class when_getting_questionnaire_sync_package_and_device_is_registered_and_package_is_absent : SyncManagerTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            exception = Catch.Exception(() =>
                syncManager.ReceiveQuestionnaireSyncPackage(deviceId, syncedPackageId, userId: Guid.NewGuid()));
        ...
        It should_throw_exception_with_message_containting__package_is_absent__ = () =>
            new[] { "package", syncedPackageId, "with questionnaire is absent" }.ShouldEachConformTo(
