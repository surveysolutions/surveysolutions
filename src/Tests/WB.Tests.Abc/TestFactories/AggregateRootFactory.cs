...
namespace WB.Tests.Abc.TestFactories
{
    public class AggregateRootFactory
    {
            ...
            bool shouldBeInitialized = true)
        {
            ...
            {
                var command = Create.Command.CreateInterviewOnClientCommand(Guid.Empty, userId ?? Guid.NewGuid(), Create.Entity.QuestionnaireIdentity(questionnaireId.Value, 1), DateTime.Now,
