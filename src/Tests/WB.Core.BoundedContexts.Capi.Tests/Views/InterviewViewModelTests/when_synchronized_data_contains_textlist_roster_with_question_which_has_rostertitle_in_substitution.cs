...
{
    internal class when_synchronized_data_contains_textlist_roster_with_question_which_has_rostertitle_in_substitution : InterviewViewModelTestContext
    {
        Establish context = () =>
        {
            ...
            textListQuestionId = Guid.Parse("21111111111111111111111111111111");
