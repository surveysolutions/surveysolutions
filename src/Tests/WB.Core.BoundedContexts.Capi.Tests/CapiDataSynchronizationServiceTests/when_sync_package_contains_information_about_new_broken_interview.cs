...
namespace WB.Core.BoundedContexts.Capi.Tests.CapiDataSynchronizationServiceTests
{
    internal class when_sync_package_contains_information_about_new_broken_interview : CapiDataSynchronizationServiceTestContext
    {
        Establish context = () =>
        {
            questionnaireMetadata = new SharedKernel.Structures.Synchronization.InterviewMetaInfo()
            {
                Comments = "my comment",
        ...
        private static SharedKernel.Structures.Synchronization.InterviewMetaInfo questionnaireMetadata;
