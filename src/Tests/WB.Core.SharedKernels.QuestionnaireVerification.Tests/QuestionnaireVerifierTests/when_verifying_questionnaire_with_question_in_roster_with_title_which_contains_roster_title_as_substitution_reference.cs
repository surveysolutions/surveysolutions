...
{
    internal class when_verifying_questionnaire_with_question_in_roster_with_title_which_contains_roster_title_as_substitution_reference : QuestionnaireVerifierTestsContext
    {
        Establish context = () =>
        {
