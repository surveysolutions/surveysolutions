...
{
    internal class when_verifying_questionnaire_with_roster_size_question_without_max_value : QuestionnaireVerifierTestsContext
    {
        Establish context = () =>
        {
        ...
        It should_return_error_with_code__WB0025__ = () =>
            resultErrors.Single().Code.ShouldEqual("WB0025");
