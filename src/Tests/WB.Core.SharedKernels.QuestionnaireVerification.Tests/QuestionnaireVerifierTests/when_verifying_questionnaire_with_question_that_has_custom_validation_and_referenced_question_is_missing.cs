...
{
    internal class when_verifying_questionnaire_with_question_that_has_custom_validation_and_referenced_question_is_missing : QuestionnaireVerifierTestsContext
    {
        private Establish context = () =>
        {
            ...
            expressionProcessor.Setup(x => x.GetIdentifiersUsedInExpression(Moq.It.IsAny<string>()))
                .Returns(new string[] { Guid.NewGuid().ToString() });
