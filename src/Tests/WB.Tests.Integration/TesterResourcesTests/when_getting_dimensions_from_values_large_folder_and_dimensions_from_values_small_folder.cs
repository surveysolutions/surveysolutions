...
namespace WB.Tests.Integration.TesterResourcesTests
{
    internal class when_getting_dimensions_from_values_large_folder_and_dimensions_from_values_small_folder : TesterResourcesTestsContext
    {
        Because of = () =>
        {
            largeDevicesDimensions = GetDimensionsNames("UI/QuestionnaireTester/WB.UI.QuestionnaireTester/Resources/values-large").ToArray();
            smallDevicesDimensions = GetDimensionsNames("UI/QuestionnaireTester/WB.UI.QuestionnaireTester/Resources/values-small").ToArray();
        };
