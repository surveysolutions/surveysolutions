...
namespace WB.Tests.Integration.ResourcesTranslationTests
{
    ...
    internal class when_checking_availability_of_tester_resources_in_russian_comparing_to_english : ResourcesTranslationTestsContext
    {
        Because of = () =>
        {
            englishResourceNames = GetStringResourceNamesFromResX(@"C:\Projects\SurveySolutions\src\Core\BoundedContexts\Tester\WB.Core.BoundedContexts.Tester\Properties\TesterUIResources.resx").ToList();
            russianResourceNames = GetStringResourceNamesFromResX(@"C:\Projects\SurveySolutions\src\Core\BoundedContexts\Tester\WB.Core.BoundedContexts.Tester\Properties\TesterUIResources.ru-RU.resx").ToList();
        };
