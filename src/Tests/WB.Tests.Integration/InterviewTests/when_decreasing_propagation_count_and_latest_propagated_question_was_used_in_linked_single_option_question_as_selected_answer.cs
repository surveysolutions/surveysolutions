...
namespace WB.Tests.Integration.InterviewTests
{
    internal class when_decreasing_propagation_count_and_latest_propagated_question_was_used_in_linked_single_option_question_as_selected_answer : InterviewTestsContext
    {
        Establish context = () =>
        {
            ...
            interview.AnswerSingleOptionLinkedQuestion(userId, linkedQuestionId, new decimal[] { }, answerTime, new decimal[] { 2 });
        ...
        It should_raise_AnswersRemoved_event_with_linked_single_option_question_id_and_propagation_vector = () =>
