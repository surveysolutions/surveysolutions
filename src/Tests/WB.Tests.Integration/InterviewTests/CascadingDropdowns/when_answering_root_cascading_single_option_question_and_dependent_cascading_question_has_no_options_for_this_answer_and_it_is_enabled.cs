    ...
    internal class when_answering_root_cascading_single_option_question_and_dependent_cascading_question_has_no_options_for_this_answer_and_it_is_enabled : InterviewTestsContext
    {
        ...
        private void BecauseOf() =>
            results = Execute.InStandaloneAppDomain(appDomainContext.Domain, () =>
            {
                ...
                var interview = SetupInterview(appDomainContext.AssemblyLoadContext, questionnaire, new object[]
                {
                ...
                {
                    interview.AnswerSingleOptionQuestion(actorId, parentSingleOptionQuestionId, RosterVector.Empty, DateTime.Now, 2);
