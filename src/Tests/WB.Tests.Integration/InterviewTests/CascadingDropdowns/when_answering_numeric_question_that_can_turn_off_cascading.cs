...
{
    internal class when_answering_numeric_question_that_can_turn_off_cascading :
        InterviewTestsContext
    {
        ...
        private void BecauseOf() =>
            results = Execute.InStandaloneAppDomain(appDomainContext.Domain, () =>
            {
                ...
                {
                    interview.AnswerNumericIntegerQuestion(Guid.NewGuid(), numericQuestionId, new decimal[] { }, DateTime.Now, 2);
