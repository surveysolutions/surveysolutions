        ...
        public void BecauseOf() =>
            results = Execute.InStandaloneAppDomain(appDomainContext.Domain, () =>
            {
                ...
                var questionnaireDocument = Create.Entity.QuestionnaireDocumentWithOneChapter(questionnaireId, new IComposite[]
                {
                    ...
                    {
                        Create.Entity.SingleQuestion(q2Id, "q2", options: options, optionsFilter: "@optioncode < (int)q1"),
                        Create.Entity.SingleQuestion(q3Id, "q3", options: options, enablementCondition: "q2==2"),
                        Create.Entity.SingleQuestion(q4Id, "q4", options: options, optionsFilter: "@optioncode % (int)q3 == 0"),
                        Create.Entity.SingleQuestion(q5Id, "q5", options: options, enablementCondition: "q4 ==2")
                    })
                });
                ...
                interview.AnswerSingleOptionQuestion(userId, q4Id, Create.Entity.RosterVector(new[] {1}), DateTime.Now, 2);
