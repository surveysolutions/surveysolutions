            ...
            results = Execute.InStandaloneAppDomain(appDomainContext.Domain, () =>
            {
                ...
                var questionnaireDocument = Create.QuestionnaireDocument(questionnaireId,
                    ...
                    Create.NumericIntegerQuestion(
                        id: rosterValidation,
                        enablementCondition: "roster.Select(x => x.age).Max() > 1")
                );
                ...
                {                    
                    ...
                    interview.AnswerNumericIntegerQuestion(userId, rosterAgeQuestionId, new decimal[1] { 0 }, DateTime.Now, 1);
                    interview.AnswerNumericIntegerQuestion(userId, rosterAgeQuestionId, new decimal[1] { 1 }, DateTime.Now, 2);

                    result.AnswerIsValid = GetFirstEventByType<QuestionsEnabled>(eventContext.Events).Questions.Any(q => q.Id == rosterValidation);
                }
