    ...
    internal class InterviewTestsContext
    {
        ...
        protected static StatefulInterview SetupStatefullInterview(QuestionnaireDocument questionnaireDocument, IEnumerable<object> events = null, ILatestInterviewExpressionState precompiledState = null)
        {
            ...
            var questionnaireRepository = Mock.Of<IQuestionnaireStorage>(repository
                => repository.GetQuestionnaire(Moq.It.IsAny<QuestionnaireIdentity>(), Moq.It.IsAny<Guid?>()) == new PlainQuestionnaire(questionnaireDocument, 1));
            ...
            ILatestInterviewExpressionState precompiledState = null)
        {
            ...
            var questionnaireRepository = Mock.Of<IQuestionnaireStorage>(repository
                => repository.GetQuestionnaire(It.IsAny<QuestionnaireIdentity>(), It.IsAny<Guid?>()) == new PlainQuestionnaire(questionnaireDocument, 1));
