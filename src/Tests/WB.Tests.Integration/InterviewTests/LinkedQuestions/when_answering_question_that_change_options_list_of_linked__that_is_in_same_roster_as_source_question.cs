        ...
        Because of = () =>
            results = Execute.InStandaloneAppDomain(appDomainContext.Domain, () =>
            {
                ...
                using (var eventContext = new EventContext())
                {
                    ...
                    result.OptionsCountForQuestion4InRoster1 = GetChangedOptions(eventContext, q4Id, IntegrationCreate.RosterVector(1))?.Length ?? 0;
                    result.OptionsCountForQuestion4InRoster2 = GetChangedOptions(eventContext, q4Id, IntegrationCreate.RosterVector(2))?.Length ?? 0;
                    result.OptionsCountForQuestion4InRoster3 = GetChangedOptions(eventContext, q4Id, IntegrationCreate.RosterVector(3))?.Length ?? 0;
                }
