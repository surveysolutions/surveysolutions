    ...
    internal class when_answering_question_that_change_options_list_of_linked_that_is_one_level_deeper_than_source_question_that_is_in_nested_rosterss : InterviewTestsContext
    {
        ...
        public void BecauseOf() =>
            results = Execute.InStandaloneAppDomain(appDomainContext.Domain, () =>
            {
                ...
                {
                    Create.Entity.FixedRoster(rosterId, variable:"r", fixedTitles: new [] { IntegrationCreate.FixedTitle(1),  IntegrationCreate.FixedTitle(2)}, children: new IComposite[]
                    {
                ...
                {
                    interview.AnswerNumericIntegerQuestion(userId, q2Id, Create.Entity.RosterVector(new[] {2, 4}), DateTime.Now, 24);
        ...
        [NUnit.Framework.Test] public void should_not_return_options_for_linked_question_in_1_1_1_roster () =>
            results.OptionsCountForQuestion3InRoster1_1_1.Should().Be(0);

        [NUnit.Framework.Test] public void should_not_return_options_for_linked_question_in_1_2_2_roster () =>
            results.OptionsCountForQuestion3InRoster1_2_2.Should().Be(0);

        [NUnit.Framework.Test] public void should_not_return_options_for_linked_question_in_1_3_1_roster () =>
            results.OptionsCountForQuestion3InRoster1_3_1.Should().Be(0);

        [NUnit.Framework.Test] public void should_return_2_options_for_linked_question_in_2_1_2_roster () =>
            results.OptionsCountForQuestion3InRoster2_1_2.Should().Be(2);

        [NUnit.Framework.Test] public void should_return_1_option_for_linked_question_in_2_3_1_roster () =>
            results.OptionsCountForQuestion3InRoster2_3_1.Should().Be(1);

        [NUnit.Framework.Test] public void should_not_return_options_for_linked_question_in_2_4_1_roster () =>
            results.OptionsCountForQuestion3InRoster2_4_1.Should().Be(0);
