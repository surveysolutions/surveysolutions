    ...
    internal class when_answering_question_that_change_options_list_of_linked_that_is_one_level_deeper_than_source_question_that_is_in_nested_rosterss : InterviewTestsContext
    {
        ...
        Because of = () =>
            results = Execute.InStandaloneAppDomain(appDomainContext.Domain, () =>
            {
                ...
                interview.AnswerMultipleOptionsQuestion(userId, q1Id, Create.RosterVector(1), DateTime.Now, new[] { 1m, 2m, 3m});
                interview.AnswerMultipleOptionsQuestion(userId, q1Id, Create.RosterVector(2), DateTime.Now, new[] { 1m, 3m, 4m });
                ...
                using (var eventContext = new EventContext())
                {
                    ...
                    var optionsForLinked1_3_1 = optionsChangedEvent.ChangedLinkedQuestions.SingleOrDefault(x => x.QuestionId.Equals(Create.Identity(q3Id, Create.RosterVector(1, 3, 1))));
                    var optionsForLinked2_1_2 = optionsChangedEvent.ChangedLinkedQuestions.SingleOrDefault(x => x.QuestionId.Equals(Create.Identity(q3Id, Create.RosterVector(2, 1, 2))));
                    var optionsForLinked2_3_1 = optionsChangedEvent.ChangedLinkedQuestions.SingleOrDefault(x => x.QuestionId.Equals(Create.Identity(q3Id, Create.RosterVector(2, 3, 1))));
                    var optionsForLinked2_4_1 = optionsChangedEvent.ChangedLinkedQuestions.SingleOrDefault(x => x.QuestionId.Equals(Create.Identity(q3Id, Create.RosterVector(2, 4, 1))));
                    ...
                    result.OptionsCountForQuestion3InRoster1_3_1 = optionsForLinked1_3_1?.Options.Length ?? 0;
                    result.OptionsCountForQuestion3InRoster2_1_2 = optionsForLinked2_1_2?.Options.Length ?? 0;
                    result.OptionsCountForQuestion3InRoster2_3_1 = optionsForLinked2_3_1?.Options.Length ?? 0;
                    result.OptionsCountForQuestion3InRoster2_4_1 = optionsForLinked2_4_1?.Options.Length ?? 0;
                }
        ...
        It should_return_no_options_for_linked_question_in_1_2_2_roster = () =>
            results.OptionsCountForQuestion3InRoster1_2_2.ShouldEqual(0);

        It should_return_2_options_for_linked_question_in_1_3_1_roster = () =>
            results.OptionsCountForQuestion3InRoster1_3_1.ShouldEqual(2);
