...
{
    internal class when_remove_by_id_called_view_is_present_and_cache_is_enabled : RavenFilesStoreRepositoryAccessorTestContext
    {
        Establish context = () =>
        {
            ...
            ravenFilesStoreRepositoryAccessor.GetById(id);
        };
        ...
        It should_return_readable_status_with_enabled_cache = () =>
            ravenFilesStoreRepositoryAccessor.GetReadableStatus().ShouldEqual("cache enabled;    cached raven file storage items: 1;");
