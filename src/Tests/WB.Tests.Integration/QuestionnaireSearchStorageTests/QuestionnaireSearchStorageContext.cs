...
namespace WB.Tests.Integration.QuestionnaireSearchStorageTests
{
    ...
    internal class QuestionnaireSearchStorageContext
    {
        ...
        public async Task InitEnvironment()
        {
            ...
            var ormSettings = new UnitOfWorkConnectionSettings()
            {
                ...
                PlainStoreUpgradeSettings = new DbUpgradeSettings(typeof(WB.UI.Designer.Migrations.PlainStore.M001_Init).Assembly, typeof(WB.UI.Designer.Migrations.PlainStore.M001_Init).Namespace)
            };
            ...
            DbMigrationsRunner.MigrateToLatest(ormSettings.ConnectionString, plainStorageSchemaName, ormSettings.PlainStoreUpgradeSettings);
