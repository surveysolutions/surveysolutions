...
{
    internal class when_answer_on_integer_question_increases_roster_size_of_disabled_roster_with_disabled_nested_roster_triggered_by_the_same_question : InterviewTestsContext
    {
        Establish context = () =>
        {
