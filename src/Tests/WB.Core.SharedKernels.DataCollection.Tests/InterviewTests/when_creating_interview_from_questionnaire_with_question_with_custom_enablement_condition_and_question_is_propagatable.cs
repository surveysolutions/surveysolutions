...
{
    internal class when_creating_interview_from_questionnaire_with_question_with_custom_enablement_condition_and_question_is_propagatable : InterviewTestsContext
    {
        Establish context = () =>
        {
