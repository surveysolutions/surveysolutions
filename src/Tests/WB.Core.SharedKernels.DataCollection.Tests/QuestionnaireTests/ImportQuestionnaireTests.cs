...
namespace WB.Core.SharedKernels.DataCollection.Tests.QuestionnaireTests
{
    internal class ImportQuestionnaireTests : QuestionnaireTestsContext
    {
        ...
        public void ImportQuestionnaire_When_Valid_Questionnaire_Imported_Correct_Event_is_Published_Then_TemplateImportedEventIsRised(string questionnaireTemplate)
        {
            using (var eventContext = new EventContext())
            {
                // arrange
