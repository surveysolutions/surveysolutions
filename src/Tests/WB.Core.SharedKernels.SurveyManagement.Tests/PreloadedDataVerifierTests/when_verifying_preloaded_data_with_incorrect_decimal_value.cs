    ...
    internal class when_verifying_preloaded_data_with_incorrect_decimal_value : PreloadedDataVerifierTestContext
    {
        private Establish context = () =>
        {
            ...
            preloadedDataServiceMock.Setup(
                x => x.ParseQuestion(Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), out outValue)).Returns(ValueParsingResult.AnswerAsDecimalWasNotParsed);
        ...
        private It should_return_single_PL0019_error = () =>
            result.First().Code.ShouldEqual("PL0019");
