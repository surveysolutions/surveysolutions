    ...
    internal class when_verifying_preloaded_data_with_linked_question : PreloadedDataVerifierTestContext
    {
        private Establish context = () =>
        {
            ...
            preloadedDataServiceMock.Setup(
                x => x.ParseQuestion(Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), out outValue)).Returns(ValueParsingResult.UnsupportedLinkedQuestion);
        ...
        private It should_return_single_PL0013_error = () =>
            result.First().Code.ShouldEqual("PL0010");
