    ...
    internal class when_verifying_preloaded_data_and_question_was_not_found : PreloadedDataVerifierTestContext
    {
        private Establish context = () =>
        {
            ...
            preloadedDataServiceMock.Setup(
                x => x.ParseQuestion(Moq.It.IsAny<string>(), Moq.It.IsAny<string>(), out outValue)).Returns(ValueParsingResult.QuestionWasNotFound);
        ...
        private It should_return_single_PL0012_error = () =>
            result.First().Code.ShouldEqual("PL0012");
