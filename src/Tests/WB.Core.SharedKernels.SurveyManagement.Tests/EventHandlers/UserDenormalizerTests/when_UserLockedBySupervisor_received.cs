...
{
    internal class when_UserLockedBySupervisor_received: UserDenormalizerContext
    {
        private Establish context = () =>
        {
            ...
            userLockedBySupervisorEvnt = CreateUserLockedBySupervisor(commandExecutorId, userId);
        };

        private Because of = () =>
            denormalizer.Handle(userLockedBySupervisorEvnt);
        ...
        private It should_user_be_locked_by_supervisor = () =>
            userToSave.IsLockedBySupervisor.ShouldEqual(true);
        
        private static UserDenormalizer denormalizer;
        private static Guid commandExecutorId;
        private static IPublishedEvent<UserLockedBySupervisor> userLockedBySupervisorEvnt;
