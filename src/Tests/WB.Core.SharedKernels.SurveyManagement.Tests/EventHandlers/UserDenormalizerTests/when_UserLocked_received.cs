...
{
    internal class when_UserLocked_received : UserDenormalizerContext
    {
        private Establish context = () =>
        {
            ...
            userUnlockedEvnt = CreateUserLocked(userId);
        };
        ...
        private It should_user_be_locked = () =>
            userToSave.IsLockedByHQ.ShouldEqual(true);
        
        private static UserDenormalizer denormalizer;
        private static Guid commandExecutorId;
        private static IPublishedEvent<UserLocked> userUnlockedEvnt;
