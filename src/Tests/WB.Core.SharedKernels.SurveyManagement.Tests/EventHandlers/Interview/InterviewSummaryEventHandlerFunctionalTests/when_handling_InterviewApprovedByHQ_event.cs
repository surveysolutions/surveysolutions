...
{
    internal class when_handling_InterviewApprovedByHQ_event : InterviewSummaryEventHandlerFunctionalTestsContext
    {
        ...
        Because of = () => 
            viewModel = denormalizer.Update(viewModel, Create.InterviewApprovedByHQEvent(userId: responsibleId, comment: comment));
        ...
        It should_commented_statuses_history_first_item_status_be_equal_to_interview_status_approved_by_headquarters = () =>
            viewModel.CommentedStatusesHistory.Single().Status.ShouldEqual(InterviewStatus.ApprovedByHeadquarters);
