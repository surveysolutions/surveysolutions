...
{
    internal class when_handling_supervisor_assigned_event : InterviewSummaryEventHandlerFunctionalTestsContext
    {
        ...
        Because of = () => 
            viewModel = denormalizer.Update(viewModel, Create.SupervisorAssignedEvent(userId: responsibleId));
        ...
        It should_commented_statuses_history_first_item_status_be_equal_to_interview_status_supervisor_assigned = () =>
            viewModel.CommentedStatusesHistory.Single().Status.ShouldEqual(InterviewStatus.SupervisorAssigned);
