...
{
    internal class when_handling_InterviewCompleted_event : InterviewSummaryEventHandlerFunctionalTestsContext
    {
        ...
        Because of = () => 
            viewModel = denormalizer.Update(viewModel, Create.InterviewCompletedEvent(userId: responsibleId));
        ...
        It should_commented_statuses_history_first_item_status_be_equal_to_interview_status_completed = () =>
            viewModel.CommentedStatusesHistory.Single().Status.ShouldEqual(InterviewStatus.Completed);
