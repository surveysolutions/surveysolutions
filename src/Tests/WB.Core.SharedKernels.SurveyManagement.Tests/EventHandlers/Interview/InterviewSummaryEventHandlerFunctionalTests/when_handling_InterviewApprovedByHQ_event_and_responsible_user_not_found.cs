...
{
    internal class when_handling_InterviewApprovedByHQ_event_and_responsible_user_not_found : InterviewSummaryEventHandlerFunctionalTestsContext
    {
        ...
        Because of = () => 
            viewModel = denormalizer.Update(viewModel, Create.InterviewApprovedByHQEvent());
