...
{
    internal class when_preloaded_data_with_single_csv_is_present_and_GetPreloadedDataMetaInformation_is_called : FilebasedPreloadedDataRepositoryTestContext
    {
        ...
        Because of = () => result = filebasedPreloadedDataRepository.GetPreloadedDataMetaInformation(csvFileId);
