...
namespace WB.Core.SharedKernels.SurveyManagement.Tests.ServiceTests.DataExport.FilebasedExportedDataAccessorTests
{
    internal class when_export_all_data_and_archive_is_present : FilebasedExportedDataAccessorTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            archiveName = filebasedExportedDataAccessor.GetFilePathToExportedCompressedData(questionnaireId, questionnaireVersion);
