...
{
    internal class when_add_action_record_called_for_interview_with_approve_by_hq_action : SqlDataExportWriterTestContext
    {
        Establish context = () =>
        {
            ...
            interviewActionExportView = new InterviewActionExportView(interviewId, InterviewExportedAction.ApproveByHeadquarter,
        ...
        Because of = () =>
            sqlDataExportWriter.AddActionRecords(interviewActionExportView, "");
        ...
        It should_command_with_action_insert_be_executed = () =>
            sqlServiceTestable.CommandsToExecute[0].ShouldEqual("insert into \"interview_actions\" values ('interviewId1', 'ApproveByHeadquarter', 'nastya', 'inter', '04/18/1984', '06:38:02');");

        It should_two_folders_be_deleted = () =>
            fileSystemAccessorMock.Verify(x => x.DeleteDirectory(Moq.It.IsAny<string>()), Times.Exactly(2));
        ...
        It should_one_folder_with_approved_data_be_deleted = () =>
            fileSystemAccessorMock.Verify(x => x.DeleteDirectory(Moq.It.Is<string>(s => s.Contains("ApprovedData"))), Times.Once);
