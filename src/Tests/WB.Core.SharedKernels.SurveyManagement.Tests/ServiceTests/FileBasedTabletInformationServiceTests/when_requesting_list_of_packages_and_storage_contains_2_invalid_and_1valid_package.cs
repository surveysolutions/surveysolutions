...
namespace WB.Core.SharedKernels.SurveyManagement.Tests.ServiceTests.FileBasedTabletInformationServiceTests
{
    internal class when_requesting_list_of_packages_and_storage_contains_2_invalid_and_1valid_package : FileBasedTabletInformationServiceTestContext
    {
        ...
        private static string[] presentFileNames = new[] { "1", "2.zip", "2@5@6.zip" };
    }
}
