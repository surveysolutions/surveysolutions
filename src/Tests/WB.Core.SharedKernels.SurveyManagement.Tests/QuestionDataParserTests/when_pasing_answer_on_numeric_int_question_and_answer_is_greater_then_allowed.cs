...
{
    internal class when_pasing_answer_on_numeric_int_question_and_answer_is_greater_then_allowed : QuestionDataParserTestContext
    {
        Establish context = () =>
        {
            answer = "5";
        ...
        It should_result_be_equal_to_5 = () =>
