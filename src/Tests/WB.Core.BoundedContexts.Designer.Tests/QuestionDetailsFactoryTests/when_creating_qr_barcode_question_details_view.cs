...
{
    internal class when_creating_qr_barcode_question_details_view : QuestionDetailsFactoryTestContext
    {
        Establish context = () =>
        {
        ...
        private static QuestionType questionType = QuestionType.QRBarcode;
