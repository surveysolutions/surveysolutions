...
{
    internal class when_creating_multi_option_details_view : QuestionDetailsFactoryTestContext
    {
        Establish context = () =>
        {
        ...
        It should_set_AreAnswersOrdered_in_areAnswersOrdered = () =>
            questionView.AreAnswersOrdered.ShouldEqual(areAnswersOrdered);
