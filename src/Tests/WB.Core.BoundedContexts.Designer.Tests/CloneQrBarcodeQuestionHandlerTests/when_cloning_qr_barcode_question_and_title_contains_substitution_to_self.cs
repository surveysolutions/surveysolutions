...
{
    internal class when_cloning_qr_barcode_question_and_title_contains_substitution_to_self : QuestionnaireTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            exception = Catch.Exception(() =>
                questionnaire.CloneQRBarcodeQuestion(questionId: questionId, title: titleWithSubstitutionToSelf,
                    variableName: variableName, isMandatory: false, enablementCondition: null, instructions: null,
