...
{
    internal class when_cloning_qr_barcode_question_and_title_is_empty : QuestionnaireTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            exception = Catch.Exception(() =>
                questionnaire.CloneQRBarcodeQuestion(questionId: questionId, title: string.Empty,
