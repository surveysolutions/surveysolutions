...
namespace WB.Core.BoundedContexts.Designer.Tests.UpdateMultiOptionQuestionHandlerTests
{
    internal class when_updating_multi_option_question_and_it_does_not_exists_in_questionnaire : QuestionnaireTestsContext
    {
        ...
        private static string validationMessage = ""; private static Option[] options = new Option[] { new Option(Guid.NewGuid(), "1", "Option 1"), new Option(Guid.NewGuid(), "2", "Option 2"), };
