...
namespace WB.Core.BoundedContexts.Designer.Tests.UpdateNumericQuestionHandlerTests
{
    internal class when_updating_numeric_question_with_variable_name_roster_title : QuestionnaireTestsContext
    {
        ...
        Because of = () =>
            exception = Catch.Exception(() => questionnaire.UpdateNumericQuestion(questionId, "title", rosterTitle, false, false, QuestionScope.Interviewer, null, null, null, null,
        ...
        It should_throw_exception_with_message_containting__variable_rosterTitle_keyword__ = () =>
