...
{
    internal class when_handling_TextListQuestionCloned_event : QuestionsAndGroupsCollectionViewInitializer
    {
        Establish context = () =>
        {
            ...
            evnt = CreateTextListQuestionClonedEvent(questionId, g3Id);
        ...
        private static IPublishedEvent<TextListQuestionCloned> evnt;
