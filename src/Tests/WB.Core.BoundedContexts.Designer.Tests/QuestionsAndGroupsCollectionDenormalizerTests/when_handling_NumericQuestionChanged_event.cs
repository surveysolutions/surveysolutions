...
{
    internal class when_handling_NumericQuestionChanged_event : QuestionsAndGroupsCollectionViewInitializer
    {
        Establish context = () =>
        {
            ...
            evnt = CreateNumericQuestionChangedEvent(q4Id);
        ...
        private static IPublishedEvent<NumericQuestionChanged> evnt;
