...
{
    internal class when_handling_TextListQuestionAdded_event : QuestionsAndGroupsCollectionViewInitializer
    {
        Establish context = () =>
        {
            ...
            evnt = CreateTextListQuestionAddedEvent(questionId, parentGroupId: g4Id);
        ...
        private static IPublishedEvent<TextListQuestionAdded> evnt;
