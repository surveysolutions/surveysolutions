...
{
    internal class when_TextListQuestionAdded_event_received : QuestionnaireInfoViewDenormalizerTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            viewState = denormalizer.Update(viewState, CreatePublishableEvent(new TextListQuestionAdded()));
