...
{
    internal class when_cloning_gps_coordinates_question_and_variable_name_not_unique : QuestionnaireTestsContext
    {
        ...
        private It should_throw_exception_with_message_containting__variable__should__unique__ = () =>
