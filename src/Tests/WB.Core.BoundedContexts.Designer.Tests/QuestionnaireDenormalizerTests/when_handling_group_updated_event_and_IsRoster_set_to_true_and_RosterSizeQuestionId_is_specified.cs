...
{
    internal class when_handling_group_updated_event_and_IsRoster_set_to_true_and_RosterSizeQuestionId_is_specified : QuestionnaireDenormalizerTestsContext
    {
        Establish context = () =>
        {
        ...
        private static IPublishedEvent<GroupUpdated> @event;
    }
}