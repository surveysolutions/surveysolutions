...
{
    internal class when_handling_group_cloned_event_and_IsRoster_set_to_true_and_RosterSizeQuestionId_is_specified : QuestionnaireDenormalizerTestsContext
    {
        Establish context = () =>
        {
            ...
            @event = CreateGroupClonedEvent(groupId: groupId, isRoster: true, rosterSizeQuestionId: rosterSizeQuestionId);
        ...
        private static IPublishedEvent<GroupCloned> @event;
    }
}