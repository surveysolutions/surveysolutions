    ...
    internal class when_adding_prefilled_question_under_roster : QuestionnaireTestsContext
    {
        ...
        Because of = () =>
            exception = Catch.Exception(() =>
                questionnaire.NewAddQuestion(questionId, rosterId, "title", QuestionType.Text, "var1",
                    false, isPrefilled, false, QuestionScope.Interviewer, null, null, null, null, null, Order.AsIs,
