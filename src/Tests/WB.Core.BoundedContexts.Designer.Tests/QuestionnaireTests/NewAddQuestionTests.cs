...
#warning Roma: when part is incorrect should be something like when answer option value contains not number
        ...
        [TestCase(QuestionType.Text)]
        [TestCase(QuestionType.GpsCoordinates)]
        public void NewAddQuestion_When_non_numeric_question_has_precicion_setting_Then_DomainException_should_be_thrown(QuestionType questionType)
        {
            // arrange
            Guid questionId = Guid.Parse("00000000-1111-0000-2222-000000000000");
            Guid groupId = Guid.Parse("00000000-1111-0000-3333-000000000000");
        ...
        [Test]
        public void NewAddQuestion_When_numeric_question_has_no_precicion_setting_Then_DomainException_should_be_thrown()
        {
            // arrange
            Guid questionId = Guid.Parse("00000000-1111-0000-2222-000000000000");
            Guid groupId = Guid.Parse("00000000-1111-0000-3333-000000000000");
        ...
        public void NewAddQuestion_When_PreFilled_Question_Contains_Any_Substitution_Then_DomainException_of_type_FeaturedQuestionTitleContainsSubstitutionReference_should_be_thrown()
        {
            ...
            TestDelegate act = () => questionnaire.NewAddQuestion(Guid.NewGuid(), groupId, "Question %test%", QuestionType.Text, "test_subst", false, true,
                                                                  false, QuestionScope.Interviewer, string.Empty, string.Empty, string.Empty,
                                                                  string.Empty, new Option[0], Order.AZ, null, null, responsibleId: responsibleId,
                                                                  linkedToQuestionId: null, isInteger: null);
            // Assert
            var domainException = Assert.Throws<DomainException>(act);
        ...
        public void NewAddQuestion_When_Non_Autopropagated_Question_Contains_Substitution_Reference_To_AutoPropagated_Then_DomainException_of_type_QuestionTitleContainsInvalidSubstitutionReference_should_be_thrown()
        {
            ...
            questionnaire.NewAddQuestion(autoQuestionId, groupId, "autoQuestion", QuestionType.AutoPropagate, "test_auto", false, false,
                                                                  false, QuestionScope.Interviewer, string.Empty, string.Empty, string.Empty,
                                                                  string.Empty, new Option[0], Order.AZ, 3, new Guid[1] { autoGroupId }, responsibleId: responsibleId,
                                                                  linkedToQuestionId: null, isInteger: null);
        ...
        public void NewAddQuestion_When_Autopropagated_Question_Contains_Substitution_Reference_To_Other_AutoPropagation_Then_DomainException_of_type_QuestionTitleContainsInvalidSubstitutionReference_should_be_thrown()
        {
            ...
            questionnaire.NewAddQuestion(autoQuestionId1, groupId, "autoQuestion1", QuestionType.AutoPropagate, "test_auto1", false, false,
                                                                  false, QuestionScope.Interviewer, string.Empty, string.Empty, string.Empty,
                                                                  string.Empty, new Option[0], Order.AZ, 3, new Guid[1] { autoGroupId1 }, responsibleId: responsibleId,
                                                                  linkedToQuestionId: null, isInteger: null);

            questionnaire.NewAddQuestion(autoQuestionId2, groupId, "autoQuestion2", QuestionType.AutoPropagate, "test_auto2", false, false,
                                                                  false, QuestionScope.Interviewer, string.Empty, string.Empty, string.Empty,
                                                                  string.Empty, new Option[0], Order.AZ, 3, new Guid[1] { autoGroupId2 }, responsibleId: responsibleId,
                                                                  linkedToQuestionId: null, isInteger: null);
