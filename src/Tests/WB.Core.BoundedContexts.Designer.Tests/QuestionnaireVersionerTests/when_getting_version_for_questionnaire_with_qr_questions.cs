...
{
    internal class when_getting_version_for_questionnaire_with_qr_questions : QuestionnaireVersionerTestContext
    {
        Establish context = () =>
        {
            questionnaire = CreateQuestionnaireDocumentWithQRQuestion();
