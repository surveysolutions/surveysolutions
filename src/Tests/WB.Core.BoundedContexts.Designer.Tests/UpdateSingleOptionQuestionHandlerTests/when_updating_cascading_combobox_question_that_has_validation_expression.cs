...
namespace WB.Core.BoundedContexts.Designer.Tests.UpdateSingleOptionQuestionHandlerTests
{
    internal class when_updating_cascading_combobox_question_that_has_validation_expression : QuestionnaireTestsContext
    {
        Establish context = () =>
        {
            ...
            questionnaire.Apply(Create.Event.UpdateSingleOptionQuestion(parentQuestionId, "cascade_parent"));
            questionnaire.Apply(Create.Event.AddTextQuestion(cascadingId, chapterId));
            questionnaire.Apply(Create.Event.UpdateSingleOptionQuestion(cascadingId, "cascade_child"));
        };
        ...
        Because of = () =>
            exception = Catch.Exception(() => questionnaire.UpdateSingleOptionQuestion(
                ...
                validationExpression: "not empty validation expression",
        ...
        It should_throw_exception_with_message_containting__answer_title_cannot_be_empty__ = () =>
            new[] { "cascading questions can't have validation expression" }.ShouldEachConformTo(
