...
{
    internal class when_cloning_single_option_question_and_question_already_exists : QuestionnaireTestsContext
    {
        private Establish context = () =>
        {
            questionnaire = CreateQuestionnaire(responsibleId: responsibleId);
            questionnaire.Apply(new NewGroupAdded { PublicKey = parentGroupId });
            questionnaire.Apply(new NumericQuestionAdded() { PublicKey = questionId, GroupPublicKey = parentGroupId });
        ...
        private Because of = () =>
            exception = Catch.Exception(() =>
                questionnaire.CloneSingleOptionQuestion(questionId: questionId,
                    title: title,
