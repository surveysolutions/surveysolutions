...
{
    internal class when_cloning_static_text_and_user_dont_have_permissions : QuestionnaireTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            exception = Catch.Exception(() =>
                questionnaire.CloneStaticText(entityId: targetEntityId, responsibleId: notExistinigUserId, sourceEntityId: sourceEntityId));
