...
{
    internal class when_cloning_static_text_and_text_contains_only_whitespaces : QuestionnaireTestsContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            exception = Catch.Exception(() =>
                questionnaire.CloneStaticText(entityId: targetEntityId, text: "  ", responsibleId: responsibleId,
