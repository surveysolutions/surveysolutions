...
{
    internal class when_verifying_questionnaire_with_2_questions_and_one_group_all_referencing_not_existing_question_in_enablement_condition :  QuestionnaireVerifierTestsContext
    {
        Establish context = () =>
        {
