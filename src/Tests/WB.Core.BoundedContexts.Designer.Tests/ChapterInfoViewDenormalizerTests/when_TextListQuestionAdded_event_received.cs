...
{
    internal class when_TextListQuestionAdded_event_received : ChaptersInfoViewDenormalizerTestContext
    {
        Establish context = () =>
        {
        ...
        Because of = () =>
            viewState =
                denormalizer.Update(viewState,
                    Create.TextListQuestionAddedEvent(questionId: questionId, parentGroupId: chapterId,
