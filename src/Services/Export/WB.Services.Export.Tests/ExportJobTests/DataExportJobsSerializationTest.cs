    ...
    public class DataExportJobsSerializationTest
    {
        ...
        public void Deserialize()
        {
            this.args = JsonConvert.DeserializeObject<DataExportProcessArgs>(
                "{\"ExportSettings\":{\"ExportFormat\":1,\"QuestionnaireId\":{\"Id\":\"6158dd074d64498f8a50e5e9828fda23$101\"}" +
                ",\"Status\":null,\"FromDate\":null,\"ToDate\":null,\"Tenant\":{\"BaseUrl\":\"http://localhost:5001/\"," +
                "\"Id\":{\"Id\":\"021d7381-6fc1-4091-92cd-c077ae1ab8be\"},\"Name\":\"devenv\"},\"Translation\":null," +
                ...
                "\"Status\":{\"CreatedDate\":\"0001-01-01T00:00:00\",\"BeginDate\":null,\"EndDate\":null," +
                "\"LastUpdateDate\":\"0001-01-01T00:00:00\",\"Status\":2,\"JobStatus\":0,\"ProgressInPercents\":40," +
                "\"IsRunning\":true,\"TimeEstimation\":null,\"Error\":null},\"ArchivePassword\":null," +
                ...
                "\"AccessToken\":\"access_token_long\",\"RefreshToken\":\"refresh_token_long\",\"StorageType\":null,\"ProcessId\":0,\"ShouldDropTenantSchema\":false}");
        }
        ...
        [Test]
        public void should_deserialize_Status_ProgressInPercents() => Assert.That(args.Status.ProgressInPercents, Is.EqualTo(40));
    }
}
