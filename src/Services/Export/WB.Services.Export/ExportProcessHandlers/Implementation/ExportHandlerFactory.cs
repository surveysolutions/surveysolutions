            ...
            switch (exportFormat)
            {
                ...
                case DataExportFormat.Binary:
                    return externalStorageType == null
                        ? (IExportHandler)serviceProvider.GetRequiredService<BinaryDataArchiveFileExportHandler>()
                ...
                case DataExportFormat.AudioAudit:
                    return externalStorageType == null
                        ? (IExportHandler)serviceProvider.GetRequiredService<AudioAuditArchiveFileExportHandler>()
