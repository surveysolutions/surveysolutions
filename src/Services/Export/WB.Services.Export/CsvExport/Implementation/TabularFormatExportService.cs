...
namespace WB.Services.Export.CsvExport.Implementation
{
    public class TabularFormatExportService : ITabularFormatExportService
    {
        ...
        public Task GenerateShortDescriptionFileAsync(TenantInfo tenant, QuestionnaireId questionnaireId, string basePath, string dataFilesExtension, bool? paradataReduced, CancellationToken cancellationToken) => 
            WriteDescriptionFileAsync(tenant, questionnaireId, basePath, dataFilesExtension, true, paradataReduced, cancellationToken);
        ...
        public Task GenerateDescriptionFileAsync(TenantInfo tenant, QuestionnaireId questionnaireId, string basePath, string dataFilesExtension, CancellationToken cancellationToken) => 
            WriteDescriptionFileAsync(tenant, questionnaireId, basePath, dataFilesExtension, false, false, cancellationToken);

        private async Task WriteDescriptionFileAsync(TenantInfo tenant, QuestionnaireId questionnaireId, string basePath, string dataFilesExtension, bool isCaptionOnly, bool? paradataReduced, CancellationToken cancellationToken)
        {
