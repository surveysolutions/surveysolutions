...
namespace WB.Services.Export.CsvExport.Implementation
{
    public class TabularFormatExportService : ITabularFormatExportService
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            await this.interviewsExporter.ExportAsync(settings, questionnaireExportStructure, questionnaire, interviewsToExport, tempPath, exportInterviewsProgress, cancellationToken);
