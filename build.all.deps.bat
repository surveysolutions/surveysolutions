REM start cmd /c "TITLE Designer Questionnaire && cd src\UI\Designer\WB.UI.Designer\questionnaire && yarn && yarn gulp dev"
...
start cmd /c "TITLE Hq App && cd src\UI\WB.UI.Designer && yarn && yarn gulp dev"
