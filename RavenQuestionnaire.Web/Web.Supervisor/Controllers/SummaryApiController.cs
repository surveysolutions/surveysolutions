    ...
    public class SummaryApiController : BaseApiController
    {
        ...
        public SummaryView Summary(SummaryListViewModel data)
        {
            var input = new SummaryInputModel(
                ...
                this.GlobalInfo.IsHeadquarter ? SummaryViewerStatus.Headquarter : SummaryViewerStatus.Supervisor)
                            {
                                Orders
                                    =
                                    data
        ...
        {
            return this.summaryTemplatesViewFactory.Load(new SummaryTemplatesInputModel()).Items;
        }
    }
}
