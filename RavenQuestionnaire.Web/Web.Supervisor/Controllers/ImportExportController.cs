...
namespace Web.Supervisor.Controllers
{
    ...
    public class ImportExportController : AsyncController
    {
        ...
        public ImportExportController(
            IDataExport exporter, ISyncProcessFactory syncProcessFactory, WB.Core.Synchronization.SyncManager.ISyncManager syncManager,
            ...
            IViewFactory<UserViewInputModel, UserView> userViewFactory)
        {
            ...
            this.logger = logger;
            this.syncProcessLogViewFactory = syncProcessLogViewFactory;
        ...
        public ActionResult Index()
        {
            ...
            SyncProcessLogView model =
                this.syncProcessLogViewFactory.Load(new SyncProcessLogInputModel());
        ...
        protected UserView GetUser(string login, string password)
        {
            ...
            if (Membership.ValidateUser(login, password))
            {
                ...
                {
                    return
                        this.userViewFactory.Load(new UserViewInputModel(login, null));
