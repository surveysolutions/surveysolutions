...
namespace RavenQuestionnaire.Core.Tests.Domain
{
    ...
    public class when_updating_image : OneEventTestFixture<UpdateImageCommand, ImageUpdated>
    {
            ...
            return new object[]
                       {
                           ...
                           new ImageUploaded(){ImagePublicKey = ImageGuid,PublicKey = QuestionGuid}
                       };
        }
        ...
        #region Overrides of DomainTestFixture<UpdateImageCommand>

        protected override UpdateImageCommand WhenExecuting()
        {
            return new UpdateImageCommand(EventSourceId, QuestionGuid, ImageGuid, ImageTitle, ImageDescription);
        }
        ...
        {
            Assert.That(TheEvent.QuestionKey, Is.EqualTo(QuestionGuid));
        }
        [Then]
        public void the_new_image_should_have_the_correct_image_id()
        {
            Assert.That(TheEvent.ImageKey, Is.EqualTo(ImageGuid));
        }
        [Then]
