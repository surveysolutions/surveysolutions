...
namespace RavenQuestionnaire.Core.Tests.CommandHandlers
{
    ...
    public class UpdateConditionsHandlerTest
    {
        ...
        public void WhenCommandIsReceived_AllConditionsShouldBeUpdated()
        {
            ...
            var question1 = entity.AddQuestion(Guid.NewGuid(), "The First Question", "", QuestionType.SingleOption, string.Empty, string.Empty, false, false, Order.AsIs, null, null, Guid.NewGuid());
            var question2 = entity.AddQuestion(Guid.NewGuid(), "The Second Question", "", QuestionType.SingleOption, string.Empty, string.Empty, false, false, Order.AsIs, null, null, Guid.NewGuid());
            var question3 = entity.AddQuestion(Guid.NewGuid(), "The Third Question", "stataCap", QuestionType.SingleOption, string.Empty, string.Empty, false, false, Order.AsIs, null, null, Guid.NewGuid());
