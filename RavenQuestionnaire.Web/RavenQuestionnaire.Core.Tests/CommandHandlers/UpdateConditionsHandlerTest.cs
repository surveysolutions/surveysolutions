...
namespace RavenQuestionnaire.Core.Tests.CommandHandlers
{
    ...
    public class UpdateConditionsHandlerTest
    {
        ...
        public void WhenCommandIsReceived_AllConditionsShouldBeUpdated()
        {
            ...
            var question1 = entity.AddQuestion("The First Question", "", QuestionType.SingleOption, string.Empty, string.Empty, Order.AsIs, null);
            var question2 = entity.AddQuestion("The Second Question", "", QuestionType.SingleOption, string.Empty, string.Empty, Order.AsIs, null);
            var question3 = entity.AddQuestion("The Third Question", "stataCap", QuestionType.SingleOption, string.Empty, string.Empty, Order.AsIs, null);
