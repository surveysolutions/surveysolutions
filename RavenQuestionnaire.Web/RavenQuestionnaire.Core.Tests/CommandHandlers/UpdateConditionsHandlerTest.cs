...
namespace RavenQuestionnaire.Core.Tests.CommandHandlers
{
    ...
    public class UpdateConditionsHandlerTest
    {
        ...
        public void WhenCommandIsReceived_AllConditionsShouldBeUpdated()
        {
            ...
            var question1 = entity.AddQuestion("The First Question", "", QuestionType.SingleOption, string.Empty, string.Empty, false, Order.AsIs, null, null, Guid.NewGuid());
            var question2 = entity.AddQuestion("The Second Question", "", QuestionType.SingleOption, string.Empty, string.Empty, false, Order.AsIs, null, null, Guid.NewGuid());
            var question3 = entity.AddQuestion("The Third Question", "stataCap", QuestionType.SingleOption, string.Empty, string.Empty, false, Order.AsIs, null, null, Guid.NewGuid());
