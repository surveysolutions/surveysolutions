...
{
    public class Headquarter_Reports_TeamsAndStatuses_GroupByTeam : AbstractMultiMapIndexCreationTask<SummaryItem>
    {
        public Headquarter_Reports_TeamsAndStatuses_GroupByTeam()
        {
