// --------------------------------------------------------------------------------------------------------------------
// <copyright file="QuestionnaireScreenIterator.cs" company="">
//   
// </copyright>
// <summary>
...
namespace Main.Core.Entities.Iterators
{
    ...
    public class QuestionnaireScreenIterator : Iterator<ICompleteGroup>
    {
        ...
        /// </summary>
        /// <returns>
        /// The System.Collections.Generic.IEnumerator`1[T -&gt; Main.Core.Entities.SubEntities.Complete.ICompleteGroup].
        /// </returns>
