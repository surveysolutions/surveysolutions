      ...
      <items>
        <it rn="Properties\UIResources.resx" nm="Cancel" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="fr-FR" tx="Annuler" er="" ts="Translated" qs="ToReview" />
          </lis>
        </it>
        ...
        <it rn="Properties\UIResources.resx" nm="Dashboard_LastEntryDate_Format" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="uk-UA" tx="{0:dd MMM HH:mm}" er="" ts="Translated" qs="ToReview" />
            <li lc="es-ES" tx="{0:dd MMM HH:mm}" er="" ts="Translated" qs="ToReview" />
            <li lc="th-TH" tx="{0:dd MMM HH:mm}" er="" ts="Translated" qs="ToReview" />
            <li lc="vi-VN" tx="{0:dd MMM HH:mm}" er="" ts="Translated" qs="ToReview" />
            <li lc="id-ID" tx="{0:dd MMM HH:mm}" er="" ts="Translated" qs="ToReview" />
            <li lc="pt-PT" tx="{0:dd MMM HH:mm}" er="" ts="Translated" qs="ToReview" />
            <li lc="ar" tx="{0:dd MMM HH:mm}" er="" ts="Translated" qs="ToReview" />
            <li lc="fr-FR" tx="{0:dd MMM HH:mm}" er="" ts="Translated" qs="ToReview" />
          </lis>
        </it>
        ...
        <it rn="Properties\UIResources.resx" nm="EndpointHint" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="es-ES" tx="Punto final de sincronización" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="ErrorMessage_InternalServerError" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="es-ES" tx="Error del servidor. Por favor, póngase en contacto con el equipo de soporte escribiendo a support@mysurvey.solutions" er="Spacing error. The text either starts or ends with a space or contains two subsequent spaces." ts="Translated" qs="ToReview" />
            <li lc="th-TH" tx="ข้อผิดพลาดของเซิร์ฟเวอร์ กรุณาติดต่อทีมสนับสนุนที่ support@mysurvey.solutions" er="" ts="Translated" qs="ToReview" />
            <li lc="vi-VN" tx="Lỗi máy chủ. Xin vui lòng liên hệ với nhóm hỗ trợ tại support@mysurvey.solutions" er="" ts="Translated" qs="ToReview" />
            <li lc="id-ID" tx="Kesalahan server. Hubungi tim dukungan at support@mysurvey.solutions" er="" ts="Translated" qs="ToReview" />
            ...
            <li lc="ar" tx="خطأ في الملقم. الرجاء الاتصال بفريق الدعم في support@mysurvey.solutions" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="ErrorMessage_Maintenance" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="The website of survey solutions designer is in maintenance mode now. Sorry for the inconvenience" er="" ts="Translated" qs="ToReview" />
            <li lc="uk-UA" tx="Сайт Survey Solutions Designe зараз в режимі супроводу. Вибачте за незручності" er="" ts="Changed" qs="ToReview" />
            <li lc="es-ES" tx="La web de Survey Solutions Designer está ahora en el modo de mantenimiento. Disculpen las molestias" er="" ts="Translated" qs="ToReview" />
            <li lc="th-TH" tx="เว็บไซต์ของสำรวจโซลูชั่นแบบเป็นโหมดบำรุงรักษา ขออภัยในความไม่สะดวก" er="" ts="Changed" qs="ToReview" />
            <li lc="vi-VN" tx="Các trang web của cuộc khảo sát giải pháp thiết kế là về chế độ bảo trì bây giờ. Xin lỗi vì sự bất tiện" er="" ts="Changed" qs="ToReview" />
            <li lc="id-ID" tx="Situs survei solusi desain adalah pada modus pemeliharaan sekarang. Maaf atas ketidaknyamanan" er="" ts="Changed" qs="ToReview" />
            <li lc="pt-PT" tx="O site de Survey Solutions Designer agora ésta em modo de manutenção. Desculpe pela inconveniência" er="" ts="Translated" qs="ToReview" />
            <li lc="ar" tx="مصمم موقع ويب حلول المسح الآن في وضع الصيانة. نأسف للإزعاج" er="" ts="Changed" qs="ToReview" />
            <li lc="fr-FR" tx="Le site web de Survey Solutions Designer est actuellement en cours de maintenance. Désolé pour le désagrément" er="" ts="Changed" qs="ToReview" />
          </lis>
        </it>
        <it rn="Properties\UIResources.resx" nm="ErrorMessage_RequestTimeout" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="Время ожидания ответа от сервера Survey Solutions Designer истекло. Пожалуйста, проверьте Ваше интернет соединение." er="" ts="Changed" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="ErrorMessage_ServiceUnavailable" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="Нет связи с Survey Solutions Designer." er="" ts="Changed" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="ErrorMessage_UpgradeRequired" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="es-ES" tx="Existe una nueva versión de la aplicación. Por favor, actualice la aplicación" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="IntegerQuestion_Hint" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="es-ES" tx="Pulse para introducir número" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="Interview_Complete_Answered" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="es-ES" tx="Respondido" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="Interview_PreviousGroupNavigation_AnsweredQuestions" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="Все ({0}) вопросы отвеченны" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="Interview_Question_Cascading_NoMatchingValue" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="Ответ &quot;{0}&quot; не соответствует ни с одной опцией" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="Interview_Question_Integer_EmptyValueError" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="pt-PT" tx="Valor vazio não pode ser salvo" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="Interview_Question_Integer_NegativeRosterSizeAnswer" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="uk-UA" tx="Відповідь '{0}' є неправильною, оскільки питання використовується як розмір списку і вказаного відповідь буде негативною" er="" ts="Translated" qs="ToReview" />
            <li lc="es-ES" tx="Respuesta '{0}' es incorrecta porque la pregunta se utiliza como tamaño de la lista y la respuesta especificada es negativa" er="" ts="Translated" qs="ToReview" />
            <li lc="th-TH" tx="คำตอบ '{0}' ไม่ถูกต้อง เพราะคำถามจะใช้เป็นขนาดของสมาชิก และระบุคำตอบเป็นลบ" er="" ts="Translated" qs="ToReview" />
            <li lc="vi-VN" tx="Câu trả lời '{0}' là không chính xác bởi vì câu hỏi được sử dụng như kích thước của danh sách và câu trả lời cụ thể là tiêu cực" er="" ts="Translated" qs="ToReview" />
            <li lc="id-ID" tx="Jawaban '{0}' benar karena pertanyaan ini digunakan sebagai ukuran dari daftar dan ditentukan jawaban negatif" er="" ts="Translated" qs="ToReview" />
            <li lc="pt-PT" tx="Resposta '{0}' está incorreta porque a pergunta é usada como tamanho do plantel e a resposta especificada é negativa" er="" ts="Translated" qs="ToReview" />
            <li lc="ar" tx="الإجابة '{0}' غير صحيحة لأن السؤال كحجم قائمة والجواب المحدد سلبي" er="" ts="Translated" qs="ToReview" />
            <li lc="fr-FR" tx="La réponse &quot;{0}&quot; est invalide parce qu'elle définit la taille du roster mais elle est négative" er="" ts="Translated" qs="ToReview" />
          </lis>
        </it>
        <it rn="Properties\UIResources.resx" nm="Interview_Question_Integer_ParsingError" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="Введенное значение не может быть интерпретировано как цело число" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="Interview_Questions_QrBarcode_SaveAnswer" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="Отсканировать штрих-код" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="Interview_Questions_RemoveRowFromRosterMessage" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="uk-UA" tx="Ви дійсно бажаєте видалити {0} рядків з пов'язаних списків?" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="Interviewer_ApplicationName" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="es-ES" tx="Entrevistador de Survey Solutions" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="Interviewer_DashboardTitle" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            <li lc="nn-nn" tx="Assignments/Census for {0}" ts="Translated" qs="ToReview" />
            <li lc="ru-RU" tx="Интервью/Перепись для {0}" ts="Translated" qs="ToReview" />
            <li lc="uk-UA" tx="Призначення/перепис для {0}" ts="Translated" qs="AutoTranslated" />
            <li lc="es-ES" tx="Tareas/censo para {0}" ts="Translated" qs="ToReview" />
            ...
            <li lc="pt-PT" tx="Atribuições/censo para {0}" ts="Translated" qs="ToReview" />
            <li lc="ar" tx="التعيينات/التعداد ل {0}" ts="Translated" qs="AutoTranslated" />
            <li lc="fr-FR" tx="Affectations / questionnaires en mode recensement pour {0}" ts="Translated" qs="ToReview" />
          </lis>
        </it>
        ...
        <it rn="Properties\UIResources.resx" nm="Interviewer_RelinkDevice_InterviewerLinkedToAnotherDeviceMessage" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            <li lc="nn-nn" tx="You are already assigned to another device" ts="Translated" qs="ToReview" />
            ...
            <li lc="th-TH" tx="คุณกำหนดให้กับอุปกรณ์อื่น" ts="Changed" qs="ToReview" />
            <li lc="vi-VN" tx="Bạn đã được đặt cho một thiết bị khác" ts="Changed" qs="ToReview" />
            <li lc="id-ID" tx="Anda sudah ditugaskan ke perangkat lain" ts="Changed" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="LoginTitleText" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="es-ES" tx="Survey Solutions Questionnaire Tester" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="PlayServicesLocationWatcher_Location_Client_not_started" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="uk-UA" tx="Роботу клієнта розташування не розпочато" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="Synchronization_UserLinkedToAnotherDevice_Description" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="uk-UA" tx="Ви не маєте будь-яких призначень на цьому пристрої. Надішлить інформацію з планшету, видаліть дані додатку і увійдіть, выкористовуючи інший обліковий запис" er="" ts="Translated" qs="ToReview" />
            <li lc="ru-RU" tx="У вас нет ниодного интервью на устройстве. Отправьте информацию о таблете, очистите данные приложения и войдите под другой учетной записью" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="TextQuestion_MaskHint" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="Нажмите для ввода текста ({0})" er="" ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\UIResources.resx" nm="Validity_NotAnswered_InterviewException_ErrorCaption" rc="" dnt="false" nms="WB.Core.SharedKernels.Enumerator.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="fr-FR" tx="La réponse n'a pas été enregistrée" er="" ts="Translated" qs="ToReview" />
          </lis>
        </it>
