      ...
      <items>
        <it rn="Properties\TesterUIResources.resx" nm="Dashboard_HaveNotBeenUpdated" rc="" dnt="false" nms="WB.Core.BoundedContexts.Tester.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="th-TH" tx="ไม่มีการปรับปรุงรายการ" ts="Changed" qs="ToReview" />
        ...
        <it rn="Properties\TesterUIResources.resx" nm="ImportQuestionnaire_Error_Forbidden" rc="" dnt="false" nms="WB.Core.BoundedContexts.Tester.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="th-TH" tx="ไม่สามารถเปิดแบบสอบถาม &quot;{0}&quot; ไม่รับอนุญาตของบัญชีผู้ใช้ออก กรุณาตรวจสอบการล็อกอินและรหัสผ่านของคุณ." ts="Changed" qs="ToReview" />
            ...
            <li lc="id-ID" tx="Tidak dapat membuka kuesioner &quot;{0}&quot;. Akun pengguna desain tidak berwenang. Silakan periksa login dan password Anda." ts="Changed" qs="ToReview" />
        ...
        <it rn="Properties\TesterUIResources.resx" nm="ImportQuestionnaire_OpenLocalInterview" rc="" dnt="false" nms="WB.Core.BoundedContexts.Tester.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="Невозможно подключиться к Survey Solutions Designer. Хотите открыть локальную копию?" er="The invariant text and the locale text end with a different punctuation mark. " ts="Translated" qs="ToReview" />
            ...
            <li lc="th-TH" tx="เชื่อมต่อแบบสำรวจวิธีการ เปิดสำเนาของแบบสอบถาม?" ts="Changed" qs="ToReview" />
            ...
            <li lc="id-ID" tx="Tidak ada koneksi ke survei solusi desain. Buka salinan lokal dari kuesioner?" ts="Changed" qs="ToReview" />
        ...
        <it rn="Properties\TesterUIResources.resx" nm="ImportQuestionnaire_PrepareQuestionnaire" rc="" dnt="false" nms="WB.Core.BoundedContexts.Tester.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            <li lc="nn-nn" tx="Preparing questionnaire to create interview" ts="Translated" qs="ToReview" />
            <li lc="ru-RU" tx="Подготовка опросника к созданию интервью" ts="Changed" qs="ToReview" />
            <li lc="es-ES" tx="Preparando cuestionario para crear entrevista" er="Spacing error. The text either starts or ends with a space or contains two subsequent spaces." ts="Translated" qs="ToReview" />
            <li lc="th-TH" tx="เตรียมแบบสอบถามจะสร้างการสัมภาษณ์" ts="Changed" qs="ToReview" />
            <li lc="vi-VN" tx="Chuẩn bị các câu hỏi để tạo ra cuộc phỏng vấn" ts="Changed" qs="ToReview" />
            <li lc="id-ID" tx="Mempersiapkan kuesioner untuk menciptakan wawancara" ts="Changed" qs="ToReview" />
        ...
        <it rn="Properties\TesterUIResources.resx" nm="ImportQuestionnaire_VerifyOnServer" rc="" dnt="false" nms="WB.Core.BoundedContexts.Tester.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="Удаленная проверка опросника на наличие ошибок" er="The invariant text and the locale text end with a different punctuation mark. " ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\TesterUIResources.resx" nm="Prefs_GpsReceiveTimeoutSecSummary" rc="" dnt="false" nms="WB.Core.BoundedContexts.Tester.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="Количество секунд, в течении которых будет ожидаться получение GPS координат" er="Spacing error. The text either starts or ends with a space or contains two subsequent spaces." ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\TesterUIResources.resx" nm="Prefs_GpsReceiveTimeoutSecTitle" rc="" dnt="false" nms="WB.Core.BoundedContexts.Tester.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="es-ES" tx="Tiempo de espera para la recepción de GPS" er="Spacing error. The text either starts or ends with a space or contains two subsequent spaces." ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\TesterUIResources.resx" nm="Prefs_HttpResponseTimeoutSummary" rc="" dnt="false" nms="WB.Core.BoundedContexts.Tester.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="Количество секунд, в течении которых будет ожидаться получение ответа от сервера" er="Spacing error. The text either starts or ends with a space or contains two subsequent spaces." ts="Translated" qs="ToReview" />
        ...
        <it rn="Properties\TesterUIResources.resx" nm="Prefs_VersionSummaryFormat" rc="" dnt="false" nms="WB.Core.BoundedContexts.Tester.Properties" bac="EmbeddedResource" hgt="0" wdt="0">
          <lis>
            ...
            <li lc="ru-RU" tx="Версия:  {0}" er="Spacing error. The text either starts or ends with a space or contains two subsequent spaces." ts="Translated" qs="ToReview" />
