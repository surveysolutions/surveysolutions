...
function BuildAndroidApp($AndroidProject, $BuildConfiguration){
	...
	& (GetPathToMSBuild) $AndroidProject '/t:PackageForAndroid' '/verbosity:minimal' '/nologo '/p:CodeContractsRunCodeAnalysis=false' "/p:Configuration=$BuildConfiguration" | Write-Host
